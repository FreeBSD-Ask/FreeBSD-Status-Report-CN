...
本季度的亮点包括成功参与 Google Summer of Code，源代码树和 Ports 领域的重要工作，以及由 30 多名开发者参加的开发者峰会。

感谢所有报告者的出色工作！本报告包含 12 项内容，祝您阅读愉快。
...
| [Summer of Code 2012 项目](https://wiki.freebsd.org/SummerOfCode2012)      |
