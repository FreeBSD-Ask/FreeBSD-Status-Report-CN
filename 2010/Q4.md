...
| 链接                                                                                           |
| ---------------------------------------------------------------------------------------------- |
| [BSDInstall 维基页面](http://wiki.freebsd.org/BSDInstall "http://wiki.FreeBSD.org/BSDInstall") |
...
过去三个月，非 Port  PR 的数量保持相对稳定，解决率略有提升，但新提交的数量也略有增加。 Port  PR 的数量有所增加，部分原因是 FreeBSD 7.4 和 FreeBSD 8.2 版本发布前的 Port 冻结。通常一旦冻结解除，这些数字会迅速下降。
...
| 链接                                                                           |
| ------------------------------------------------------------------------------ |
| [NAT64 补丁 for pf](http://ecdysis.viagenie.ca/ "http://ecdysis.viagenie.ca/") |
...
| 链接                                                                                              |
| ------------------------------------------------------------------------------------------------- |
| [FreeBSD 日语网站](http://www.freebsd.org/ja/ "http://www.FreeBSD.org/ja/")                       |
| [FreeBSD 日语文档项目网页](http://www.jp.freebsd.org/doc-jp/ "http://www.jp.FreeBSD.org/doc-jp/") |
...
| 链接                                                                                                                       |
| -------------------------------------------------------------------------------------------------------------------------- |
| [总体设计描述。](http://people.freebsd.org/~mav/graid_design.h "http://people.FreeBSD.org/~mav/graid_design.h")            |
| [项目 SVN 分支。](http://svn.freebsd.org/viewvc/base/projects/graid/ "http://svn.FreeBSD.org/viewvc/base/projects/graid/") |
...
| 链接                                                                                                                              |
| --------------------------------------------------------------------------------------------------------------------------------- |
| [ARM 的旧补丁](http://people.freebsd.org/~raj/patches/arm/dove_v6.diff "http://people.FreeBSD.org/~raj/patches/arm/dove_v6.diff") |
...
| 链接                                                                                                            |
| --------------------------------------------------------------------------------------------------------------- |
| [FreeBSD/EC2 状态页面](http://www.daemonology.net/freebsd-on-ec2/ "http://www.daemonology.net/freebsd-on-ec2/") |
...
| 链接                                                                                                        |
| ----------------------------------------------------------------------------------------------------------- |
| [Chromium 首页](http://www.chromium.org/Home "http://www.chromium.org/Home")                                |
| [截图](http://people.freebsd.org/~bapt/chrome9-fbsd.png "http://people.FreeBSD.org/~bapt/chrome9-fbsd.png") |
...
| 链接                                                                                                                                                                          |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [关于](http://www.arjmobile.com/Marcelo_Araujo/Blog/Entries/2010/11/22_Port-sandbox.html "http://www.arjmobile.com/Marcelo_Araujo/Blog/Entries/2010/11/22_Port-sandbox.html") |
| [源代码](http://gitorious.org/port-sandbox/port-sandbox/trees/master "http://gitorious.org/port-sandbox/port-sandbox/trees/master")                                           |
| [截图](http://www.arjmobile.com/Marcelo_Araujo/My_Albums/Pages/Port-Sandbox.html "http://www.arjmobile.com/Marcelo_Araujo/My_Albums/Pages/Port-Sandbox.html")                 |
...
也许最有趣的新特性是，对于 -e、-s、--clean-distfiles、--clean-packages、--check-depends 和 --check-port-dbdir 等功能，您现在可以指定 -y 或 -n 来自动提供对应的 "yes/no" 问题的答案。-o、-r 和 --index-only 选项也进行了大幅度改进，现在要么运行得更好，要么至少按照广告的方式工作。
...
| 链接                                                                                          |
| --------------------------------------------------------------------------------------------- |
| [ROS 网站](http://www.ros.org/wiki/ "http://www.ros.org/wiki/")                               |
...
1. 仍然需要更多的人来帮助展位和开发者会议室的工作。如果您想提供帮助，请联系 Daniel 或 Marius。
