...
随着 Gtk+ 3.20 的发布，主题支持再次发生变化，且这些变化不向后兼容。如果您的主题更新需要新的 Gtk+ 版本，请随时将其作为阻塞问题添加到 GNOME/Gtk+ 3.20 更新问题中。此问题将在 GNOME 3.20 准备好后用于 exp-run，并跟踪与主题相关的 Port。此外，存在一个问题，即打开和保存对话框中的内容变得不可见。
