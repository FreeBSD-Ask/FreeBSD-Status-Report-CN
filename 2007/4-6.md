...
Gábor Kövesdán 正在为 Ports 基础设施做一些改进。今年，他旨在解决长期存在的问题，这些问题在 GNATS 中跟踪，但最近没有志愿者参与。通过 Andrew Pantyukhin 的指导，他还以更实际的方式重新实现了 Ports 的 DESTDIR 支持。该项目的完整描述和状态可以在 Gábor 的 2007 谷歌编程之夏 Wiki 页面上找到。
...
Gavin Atkinson 通过在 FreeBSD 集群上获得 GNATS 账户加入了 bugbuster 团队。他继承了 Matteo Riondato 的工作，后者最终获得了完整的源代码提交权限。到目前为止，他已帮助关闭了近 150 个 PR，其中包括许多已过时的 PR。欢迎加入！
