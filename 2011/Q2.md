...
我们导入了 clang/llvm 的更新快照，带来了许多新特性。最显著的是一个新的寄存器分配器，带来显著的运行时性能提升。如果你之前做过 clang/llvm 的性能评估，现在是重新评估的好时机！
...
对于 FreeBSD 手册，开始了内核配置部分的翻译工作。此外，我们还计划翻译即将发布的发布说明，因为这对日本用户也非常重要。
...
在第二季度，我们新增了 3 位提交者，收回了 2 个提交位，并为 portmgr 添加了一个新成员。
