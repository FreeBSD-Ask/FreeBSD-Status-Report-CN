...
感谢所有报告者的出色工作！本报告包含了 36 项内容，希望您阅读愉快。
...
我们导入了 clang/llvm 的更新快照，带来了许多新特性。最显著的是一个新的寄存器分配器，它带来了显著的运行时性能提升。如果您之前做过 clang/llvm 的性能评估，现在是重新评估的好时机！
...
上述工作，以及我们为项目做的许多其他任务，都离不开捐赠。请帮助我们捐款，或请求您的公司捐款。如果您需要，我们很乐意向您或您的公司发送营销资料。了解如何捐款，请访问 [http://www.FreeBSDFoundation.org/donate/](http://www.freebsdfoundation.org/donate/)。
...
联系: Hiroki Sato <[hrs@FreeBSD.org](mailto:hrs@FreeBSD.org)>
...
## [Google Summer of Code](https://www.freebsd.org/status/report-2011-04-2011-06.html#Google-Summer-of-Code)
...
我们很高兴参与第七届谷歌编程之夏。在期中评估后，我们有 15 个项目在向最终评估迈进。您可以通过查看学生个人的 Wiki 页面或订阅 soc-status 邮件列表来查看最新状态。
