...
6 月，项目中长时间进行的替换缺陷跟踪系统的项目终于完成。从 6 月 3 日起，FreeBSD 项目切换到 Bugzilla 作为其缺陷跟踪系统。所有 GNATS PR 的历史记录均已保留，因此无需重新开启旧的工单。目前仍在进行相关工作，以重现以前应用于 GNATS 的一些集成调整，但所有必要的功能均已实现，项目开始受益于 Bugzilla 带来的新功能。
