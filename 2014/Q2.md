...
2014 年第二季度对于 FreeBSD 项目来说是一个非常忙碌且富有成效的时期。新的 FreeBSD 核心团队已选举产生，FreeBSD Ports 管理团队分支了第二个季度的 “stable” 分支，FreeBSD 发布工程团队正在完成 FreeBSD 9.3-RELEASE 的周期，许多令人兴奋的新功能已加入 FreeBSD。
