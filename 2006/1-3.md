...
### [libpkg - 软件包管理库](https://www.freebsd.org/status/report-2006-01-2006-03.html#libpkg---Package-management-library)
...
### [Ports Collection](https://www.freebsd.org/status/report-2006-01-2006-03.html#Ports-Collection)
...
选择使用 fc3 而不是 fc4 或 fc5，是为了确保过渡尽可能顺利，减少破坏。我们当前默认的 linux_base-8 已经使用了几个 fc3 的 RPM 包，因此不应该有太多问题需要解决。
