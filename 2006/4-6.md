...
### [改进 Ports Collection](https://www.freebsd.org/status/report-2006-04-2006-06.html#Improving-Ports-Collection)
...
在过去几周的工作集中在对新服务器进行基准测试，并使其准备好投入生产。最终它需要新家，因为我不想让它一直在我的地下室运行（它真的很吵！）。
...
### [Ports Collection](https://www.freebsd.org/status/report-2006-04-2006-06.html#Ports-Collection)
...
### [更新 Ports Collection 中的 Linux 用户空间基础设施](https://www.freebsd.org/status/report-2006-04-2006-06.html#Update-of-the-Linux-userland-infrastructure-in-the-Ports-Collection)
...
在本季度发布了 BSDInstaller 的快照，显示了安装过程中存在一些错误。大部分错误现在修复。
