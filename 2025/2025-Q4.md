...
这是 2025 年第四期状态报告，共包含 28 条条目。

由于允许迟交会导致报告持续延后数月发布，现已决定对此进行调整。从下个季度开始，将对报告的提交设定截止日期，即在季度结束后一个月的 14 天前，并且将对所有人严格执行该截止日期，无论提交者还是团队。随后，将在汇总完成后尽快发布（可能在该月月底之前）完整的状态报告，内容仅包含在截止日期前提交的条目。

将不再催促提交报告。如果你错过了截止日期，请在下个季度提交一份更为全面的报告。

这一新策略应有助于每期报告保持新鲜、相关且及时。
...
来自各个官方和半官方团队的条目，可在 [Administration Page](https://www.freebsd.org/administration/) 中找到。
...
[Foundation Partnership Program](https://freebsdfoundation.org/our-donors/freebsd-foundation-partnership-program/) URL: [https://freebsdfoundation.org/our-donors/freebsd-foundation-partnership-program/](https://freebsdfoundation.org/our-donors/freebsd-foundation-partnership-program/)
...
FreeBSD 基金会是一家 501(c)(3) 非营利组织，致力于通过技术和非技术支持推动 FreeBSD 的发展。基金会完全依靠捐款资助，支持软件开发、基础设施、安全与协作工作；组织活动和开发者峰会；提供教育资源；并在法律事务中代表 FreeBSD 项目。

#### 操作系统改进

在本季度，共有 346 次 `src`、72 次 `ports` 和 58 次 `doc` 提交由 FreeBSD 基金会资助。

有关这些已提交开发工作的详细内容，请参阅以下报告条目：
...
* [音频栈改进](https://www.freebsd.org/status/report-2025-10-2025-12/#_audio_stack_improvements)
...
* [LinuxKPI 802.11 及原生无线更新](https://www.freebsd.org/status/report-2025-10-2025-12/#_linuxkpi_802_11_and_native_wireless_update)
* [挂起/恢复改进](https://www.freebsd.org/status/report-2025-10-2025-12/#_suspendresume_improvement)
...
* [USB 内核调试改进](https://www.freebsd.org/status/report-2025-10-2025-12/#_usb_kernel_debugging_improvements)
...
基金会还支持着两项重大计划：笔记本支持与可用性项目（与 [Quantum Leap Research](https://www.ql-research.com/) 合作）以及由 [Sovereign Tech Agency](https://www.sovereign.tech/) 委托的 [infrastructure modernization project](https://www.freebsd.org/status/report-2025-10-2025-12/#_infrastructure_modernization)。有关这两项工作的背景信息，请参阅 [2025Q1 quarterly status report](https://www.freebsd.org/status/report-2025-01-2025-03/#_freebsd_foundation)。

我们已开始为 FreeBSD 连续第 22 次参与 [Google Summer of Code (GSoC)](https://summerofcode.withgoogle.com/) 做准备。有兴趣贡献 [project ideas](https://wiki.freebsd.org/SummerOfCodeIdeas) 或担任导师的人士，欢迎联系 [soc-admins@FreeBSD.org](mailto:soc-admins@FreeBSD.org)。

#### 倡导

在 2025 年第四季度，我们的倡导工作重点在于扩展教育视频内容，吸引了前所未有的观众，将社区凝聚在一起举办了一次富有成效的 Vendor Summit，并回顾了那些有助于维持并提升人们对 FreeBSD 兴趣的工作。以下是基金会在 2025 年第四季度为 FreeBSD 进行倡导的部分方式：

* [2025 年 11 月 FreeBSD Vendor Summit](https://freebsdfoundation.org/news-and-events/event-calendar/fall-2025-freebsd-summit/) 于 2025 年 11 月 6–7 日在加利福尼亚州圣何塞举行。你可以在我们的 FreeBSD Meetings 频道观看 Summit 回顾视频 [这里](https://youtube.com/playlist?list=PLQCocwvkAeYyOanEhhMvbEOy75wgyROkl&si=qD64PG0uBRd1nleN)。
...
* 申请并获准在 FOSDEM 设立展位，该活动将于 2026 年 1 月 31 日 — 2 月 1 日举行。我们将与 Illumos 团队共享展位。
...
* 发布了以下博客和视频，以帮助向社区传达信息并进行教育：
  ...
  * [FreeBSD 缩小笔记本差距：第一年项目更新](https://freebsdfoundation.org/blog/freebsd-closes-the-laptop-gap-year-one-project-update/)
  * [2025：倡导、社区与成长之年](https://freebsdfoundation.org/blog/2025-a-year-of-advocacy-community-and-growth/)
  ...
  * [FreeBSD 在 OCI Runtime Specification v1.3 中获得官方支持](https://freebsdfoundation.org/blog/freebsd-officially-supported-in-oci-runtime-specification-v1-3/)
  ...
  * [FreeBSD 桌面安装程序技术预览](https://www.youtube.com/watch?v=vbWOLzGDa4I)
  * [在 FreeBSD 上安装每一种窗口管理器](https://www.youtube.com/watch?v=q4PNSeNXEww)
* 发布了 [2025 年 9 月](https://freebsdfoundation.org/news-and-events/newsletter/september-2025-newsletter/)、[2025 年 11 月](https://freebsdfoundation.org/news-and-events/newsletter/november-2025-newsletter/) 和 [2025 年 12 月](https://freebsdfoundation.org/news-and-events/newsletter/december-2025-newsletter/) 的 FreeBSD Foundation 新闻通讯。
* 发布了 FreeBSD Journal 的 [7 月/8 月/9 月](https://freebsdfoundation.org/our-work/journal/browser-based-edition/embedded-2/) 期刊，并提供文章的 HTML 版本。

#### 持续集成与工作流程改进

基金会支持一名全职员工，专门负责改进项目的持续集成系统和测试基础设施。

#### 法律 / FreeBSD 知识产权

基金会拥有 FreeBSD 商标，我们有责任对其进行保护。我们还为核心团队提供法律支持，以调查出现的相关问题。
...
团队管理了 15.0-RELEASE，并于 12 月完成了正式的 RELEASE 构建与发布公告；这是来自新 **stable/15** 分支的首个发布版本。作为其中的一部分，大量工作用于建立一套系统，以便为 15.0-RELEASE 基础系统安全地构建、签名和分发包仓库。

针对即将到来的 14.4-RELEASE 周期的规划已开始。

发布工程团队继续为 **main**、**stable/14** 和 **stable/13** 分支提供每周开发快照构建，并开始为新的 **stable/15** 分支提供每周开发快照构建。
...
### Alpha-Omega Beach Cleaning 项目

链接：
[Alpha-Omega — Linux Foundation 项目](https://alpha-omega.dev/) URL: [https://alpha-omega.dev](https://alpha-omega.dev/)
...
联系方式：Pierre Pronchery [[pierre@freebsdfoundation.org](mailto:pierre@freebsdfoundation.org)](%[5Bpierre@freebsdfoundation.org](mailto:5Bpierre@freebsdfoundation.org)%5D(mailto:pierre@freebsdfoundation.org))

Alpha-Omega 的使命是推动关键开源项目和生态系统实现可持续的安全改进。在 2024 年与 FreeBSD 基金会成功合作——审计 bhyve 虚拟机监控器和 Capsicum 沙箱框架——之后，Alpha-Omega 再次选择了 FreeBSD，这次开展 Alpha Omega Beach Cleaning 项目。这项新资助旨在整体提升 FreeBSD 基础系统中第三方软件的安全性和维护状况。FreeBSD 基金会获得了该资助，并负责管理和执行该项目。

自 2025Q3 上一份报告以来，已完成以下任务：
...
一个全局数据库文件包含了为该项目收集的信息，并与由德国 Sovereign Tech Agency 资助的 SBOM 计划协作完成。其结构在过去几个月中也已简化，但仍保持 YAML 格式。它仍然以 [database.yml](https://github.com/FreeBSDFoundation/alpha-omega-beach-cleaning/blob/main/database.yml) 的形式提供。

仓库中的 aobc-generate Go 程序已更名为 aobc-tool。除之前的交付成果外，它现在还能够生成一组 SBOM 文件。这通过 pkg-config 格式的中间文件完成，然后借助 pkgconf 项目的 bomtool 程序将其转换为 SPDX：
...
这些信息包括为每个第三方组件所识别的相应代码所有者。aobc-tool 程序还能够为源代码树的给定部分建议已知的代码所有者。所有列出的代码所有者已于 2025 年 12 月联系，以告知他们该项目，并确认他们与相关组件的关联。

目前收集到的反馈均为积极反馈，其中包括建议将该工具打包进 FreeBSD ports。然而，目前看来，将该工具重写为适合纳入基础系统的形式（例如使用 Lua）更为合适。

最后，剩余任务将持续执行至 2026 年第一季度结束：

* 整合审查方法
* 规划执行与协调
* 最终报告

该计划已于 11 月向 srcmgr 委员会进行了介绍。他们的意见和反馈将在项目的最后阶段予以考虑。
...
联系方式：Tuukka Pasanen [[tuukka.pasanen@ilmi.fi](mailto:tuukka.pasanen@ilmi.fi)](%[5Btuukka.pasanen@ilmi.fi](mailto:5Btuukka.pasanen@ilmi.fi)%5D(mailto:tuukka[.pasanen@ilmi.fi](mailto:.pasanen@ilmi.fi)))

开源漏洞数据库工作自 5 月以来一直在进行。该工作的目标是生成一个 OSV 数据库，并淘汰旧的 VuXML 数据库格式。

目前已有一个测试数据库和一个针对 [pkg(8)](https://man.freebsd.org/cgi/man.cgi?query=pkg&sektion=8&format=html) 的拉取请求。该测试数据库可以从 VuXML 更新并转换为 OSV JSON 格式。用于更新并创建供 pkg 使用的合并数据库文件的所需工具已完成。还支持导出为 Commonmark 格式，并且在 GitHub 上可正常渲染。

此外，已在 OSV Schema 中实现对 FreeBSD 的上游支持，使得 OSV 文件可以根据官方来源进行验证。同时也在推进 PURL 相关工作，目前正缓慢进展。

如果你希望为该项目提供帮助，以下是一些任务：

* 验证从 VuXML 到 OSV 的转换是否准确
* 验证 pkg 是否可以使用 OSV 数据库并生成正确输出
...
软件物料清单（SBOM）项目自 5 月以来一直在进行，其目标是提供必要的工具，以便从 FreeBSD Ports 和基础系统生成 SBOM。

2025Q4 的一项主要进展是将 spdxtool 上游合入 pkgconf。该上游代码确保 pkgconf 工具在下一个版本中具备符合 SPDX Lite 3.0.1 配置文件的 SBOM 创建工具。

另一项重要工作是收集构成 FreeBSD 基础系统一部分的应用程序信息。这些应用程序主要位于 FreeBSD git 仓库中的 usr.bin、usr.sbin、sbin 和 bin 目录。FreeBSD Alpha Omega Beach Cleaning 项目在此过程中发挥了关键作用，因为它收集了有关第三方库和应用程序的信息，我也为此做出了贡献。现在已有 Lua 脚本和一个文件，可以生成 pkgconf 的 spdxtool 所需的文件，并可导出为 SPDX JSON-LD 格式。

使用这些收集到的信息和当前原始数据的工具可以在我 fork 的 FreeBSD src 树中找到。主要而言，所有包含 SPDX-License-Identifier 的 C 文件和头文件现已被收集并处理。

此外，还曾尝试为 FreeBSD Ports 的每个包上游合入 SBOM 生成功能，但该工作已停滞，且需要更新。

如果你希望为此工作提供帮助：

* 为 FreeBSD src 下的 C 文件和头文件添加 SPDX-License-Identifier 头部。
* 验证当前文件中的 SPDX-License-Identifier 是否正确。
* 验证已收集的信息是否准确。目前，所有在第 1、7 和 8 节中具有 man 手册页的工具都已添加，其描述通过脚本从 man 手册页中提取。这些内容可能存在错误。

赞助方：FreeBSD 基金会

### bhyve 的完整 CPUID 控制

联系人：Hans Rosenfeld [[rosenfeld@grumpf.hope-2000.org](mailto:rosenfeld@grumpf.hope-2000.org)](%[5Brosenfeld@grumpf.hope-2000.org](mailto:5Brosenfeld@grumpf.hope-2000.org)%5D(mailto:rosenfeld@grumpf.hope-2000.org))

#### 简介

操作系统内核以及某些用户空间库和程序通常需要知道它们运行的 CPU 型号以及可用的架构特性。在基于 x86 的平台上，CPUID 指令可用于查询 CPU 的所有这些信息。

在虚拟机环境中，并非主机 CPU 报告的所有信息都应提供给 VM 客户端，某些 CPU 信息（如系统拓扑信息）需要修改以匹配 VM 配置，同时还有一些额外信息需要报告，而真实 CPU 并不支持，例如虚拟机管理程序标识。

因此，作为其正常操作的一部分，bhyve 为其 VM 客户端模拟 x86 CPUID 指令。目前，大部分来自主机 CPU 的 CPUID 信息会传递给 VM 客户端，同时屏蔽掉部分特性，并且还报告关于虚拟机管理程序、其能力和配置的综合信息。目前在 bhyve 中，这些都尚不可显式配置。

#### 动机

完全控制为 VM 客户端模拟的 CPUID 信息具有多种重要用途：

##### VM 迁移

为了在不同 VM 主机之间迁移正在运行或暂停的 VM，通常要求两个相关的 VM 主机都运行在相同或至少特性兼容的主机 CPU 系列、型号和步进上。即使是 CPU 型号和步进的细微差异也可能导致可用特性集不同。

控制客户端 VM 的 CPUID 信息允许操作员限制 VM 使用所有可能运行的 VM 主机共享的 CPU 特性子集，这也可以基于抽象的 x86 架构级别，而非真实 CPU 型号。

这一功能目前在 Linux 上由 QEMU/KVM 支持，在 bhyve 中提供等效支持是实现完整功能 VM 在线迁移的关键一步。

##### 固定 CPU 型号

某些软件会检查 CPU 系列/型号/步进以及 CPU 品牌字符串以确保软件兼容性。由于 VM 迁移或 VM 主机硬件变化而导致这些参数改变，会被检测为系统变化，可能会禁用专有软件许可证。能够使用预定义的 CPU 型号（无论基于真实 CPU 还是架构子集）可完全避免此问题。

##### 虚拟机管理程序标识修改

某些软件（如 Nvidia 驱动）会检查虚拟机管理程序标识以匹配特定已知值。Bhyve 自我标识为 "bhyve bhyve "，而 KVM 报告 "KVMKVMKVM\0\0\0"。虽然在每个 VM 基础上通过命令行切换修改 bhyve 的虚拟机管理程序标识是可能的，但利用完整 CPUID 控制实现此功能会更加自然，并产生更清晰的设计。
...
用于 CPUID 控制的 vmm 内核部分的基础实现已在 illumos 上的 bhyve 中存在多年。此代码由 Oxide 编写，用于其基于 FreeBSD/bhyve 内核组件移植到 illumos 的 Propolis 虚拟机管理程序，未使用任何 bhyve 的用户空间代码。
...
该项目的持续工作旨在将现有概念验证工作集成到 FreeBSD，并添加以下可用性功能：

* 用户友好的配置方法，可根据需要覆盖单个位、部分或整个 CPUID 功能，同时保留其余主机 CPUID 信息或预定义 CPUID 配置
* 用户友好的配置方法，用于设置 bhyve 报告的虚拟机管理程序标识
* 一组基于常见 x86 架构级别的预定义 CPUID 配置，也可包括少量真实 CPU 型号的 CPUID 数据，并提供用户友好的方法为 VM 选择其中之一

赞助方：FreeBSD 基金会

### 基础设施现代化

联系人：Ed Maste [[emaste@FreeBSD.org](mailto:emaste@FreeBSD.org)](%[5Bemaste@FreeBSD.org](mailto:5Bemaste@FreeBSD.org)%5D(mailto:emaste@FreeBSD.org))
联系人：Alice Sowerby [[alice@freebsdfoundation.org](mailto:alice@freebsdfoundation.org)](%[5Balice@freebsdfoundation.org](mailto:5Balice@freebsdfoundation.org)%5D(mailto:alice@freebsdfoundation.org))

该项目于 2024 年第三季度启动，由 Sovereign Tech Agency 委托，预算为 745,000 美元，支出截止至 2025 年底。主要目标是改善基础系统、Ports 和软件包的安全工具，更新项目基础设施以加快开发速度，增强构建安全性，并使新开发者更易上手。
...
截至 2025 年 12 月底，所有五个工作包均已完成，项目已结束。撰写本文时（12 月中旬），部分内容仍在审查中，这些内容已移交给基金会工作人员进行适当落地。
...
* 升级 Bugzilla 至受支持的版本，以提高安全性并利用新功能。
...
详细范围由 core@、srcmgr@、secteam@ 共同制定。

工作项如下：

* 必须完成

  * 所有源码发布构建案例/工件无需 root（已完成）
  * Src 工件可重复构建（已完成）
  * 正式化并记录 make world 和 release.sh（审查中）
* 应该完成
...
该工作包通过现代化和安全化现有 CI/CD 系统，并将其扩展至覆盖 FreeBSD Ports Collection 中的第三方软件包，从而改善了 CI/CD 自动化，简化了新旧软件的交付和运维。
...
##### 工作包 D：Ports 和软件包安全改进

该工作包以多种方式提高了 FreeBSD Ports 和软件包集合的安全性。我们增加了对 OSV（开源漏洞）格式的支持，这是一种标准化描述安全漏洞的方式。我们还构建了基本工具，从全球安全数据库下载漏洞信息，特别关注 NIST 通用平台枚举（CPE）字典。

[ pkg(8) ](https://man.freebsd.org/cgi/man.cgi?query=pkg&sektion=8&format=html) 工具现在可以创建和读取 CPE 字符串，但尚不支持 CPE JSON 格式。我们为 CPE 和 OSV 解析编写了新测试用例，并更新了现有的 [ pkg(8) ](https://man.freebsd.org/cgi/man.cgi?query=pkg&sektion=8&format=html) 安全审计测试。此外，我们创建了一个测试仓库，将 FreeBSD 漏洞数据转换为 OSV 格式，可与 [ pkg(8) ](https://man.freebsd.org/cgi/man.cgi?query=pkg&sektion=8&format=html) 配合使用。该测试仓库已进行准确性审查，从旧 FreeBSD VuXML 格式转换到新 OSV 格式的过程现在已简化。
...
我们进行了修改（目前审查中），将基础系统和 Ports 树的单个来源数据整合为统一的高级视图。我们还创建了工具，可扫描 FreeBSD 源代码树并生成涵盖整个软件栈的 SBOM 报告。

FreeBSD Ports 树已有良好的 SBOM 元数据和成熟的包依赖跟踪工具，因此我们为 Ports 提供的 SBOM 解决方案已成熟并进入审查阶段。然而，FreeBSD 基础系统使用完全不同的构建系统，SBOM 信息分散在整个仓库中。主要挑战是将所有依赖和包信息集中到一处。因此，FreeBSD 基础系统的 SBOM 创建仍处于技术预览阶段，目前仅提供示例数据。
...
联系人：Alfonso Sabato Siciliano [[asiciliano@FreeBSD.org](mailto:asiciliano@FreeBSD.org)](%[5Basiciliano@FreeBSD.org](mailto:5Basiciliano@FreeBSD.org)%5D(mailto:asiciliano@FreeBSD.org))

Parthenope 是一个模块化、两步式的 FreeBSD 操作系统安装程序，主要使用 Lua 编写。安装过程分为两个阶段：

1. 第一步，通过各种交互界面生成配置文件和安装命令。
2. 第二步，根据先前创建的文件执行实际系统安装。

该项目简单、可扩展且灵活，旨在支持多种前端、语言、安装模式（“Auto”“Easy”和“Expert”）、交互级别以及日志选项。

Parthenope 起初是一个个人项目，用于回答一个简单问题：“在我的笔记本上安装 FreeBSD 时，我希望有哪些功能？”此后，它发展为一个开源工具，任何人都可以使用、适配或扩展以满足自己的需求。
...
联系人：Abhinav Chavali [[abhinavchavali12@gmail.com](mailto:abhinavchavali12@gmail.com)](%[5Babhinavchavali12@gmail.com](mailto:5Babhinavchavali12@gmail.com)%5D(mailto:abhinavchavali12@gmail.com))

#### 描述

本项目旨在为 QEMU 实现一个 [vmm(4)](https://man.freebsd.org/cgi/man.cgi?query=vmm&sektion=4&format=html) 加速器后端。通过将 QEMU 与 FreeBSD 原生虚拟机管理程序基础设施接口对接，用户可以使用硬件虚拟化扩展（VMX/SVM）以接近原生的性能运行虚拟机，类似于 KVM 在 Linux 上的功能。这将 QEMU 丰富的设备模拟生态与 FreeBSD 内核虚拟机管理程序的性能结合起来。

#### 状态

该后端目前已足够功能化，可使用单个 vCPU 启动 FreeBSD 客户端。用于将 QEMU 与 `libvmmapi` 接口对接的核心基础设施已建立。关键点是，中断控制器（8259 PIC、IOAPIC、LAPIC）现在成功使用内核的 `vmm` 实现，而非用户空间模拟。
...
* 设备卸载：RTC 和 HPET 定时器目前仍由 QEMU 在用户空间模拟。需要重新设计以使用内核 `vmm` 版本，从而获得更高性能和正确性。
* 一般稳定性：如同任何虚拟机管理程序后端，我们需要在不同客户操作系统类型上进行边界情况测试和压力测试的协助。

感谢 Google 的赞助，以及 FreeBSD 项目提供的指导和贡献系统的机会。

赞助方：Google Summer of Code 2025
...
联系人：Hayzam Sherif [[hayzam@alchemilla.io](mailto:hayzam@alchemilla.io)](%[5Bhayzam@alchemilla.io](mailto:5Bhayzam@alchemilla.io)%5D(mailto:hayzam@alchemilla.io))

Sylve 是一个现代化的 FreeBSD 统一系统管理平台，灵感来自 Proxmox。它提供集成的 Web 界面，用于管理虚拟机（通过 Bhyve）、Jails、ZFS 存储、网络和防火墙。
...
* ZFS 管理：我们现在使用 [GitHub - gzfs](https://github.com/alchemillahq/gzfs)，它是对 zfs/zpool/zdb CLI 的 Go 封装，提供完整的 ZFS 池和数据集创建与管理支持。相比以前的实现，性能和可靠性都有提升。
* 虚拟机和 Jail 存储管理：初始化期间，用户可选择 VM（磁盘/zvols）和 Jail（数据集）创建所在的池，所有磁盘/数据集创建将在后台自动完成。

##### Jails

* 添加了对 Linux Jails 的支持，使用 FreeBSD Linuxulator。用户可通过 Web 界面创建、管理和监控 Linux Jails。目前仍为实验性，但已在 Rocky Linux 和 Alpine 上进行广泛测试。
* 对 Jails 进行了多项改进，用户在创建/编辑/查看完整 Jails 时可以提供更多选项。
...
下载器现在支持自动解压多种归档格式，包括 .tar.gz、.zip、.xz 和 .bz2，并支持磁盘镜像自动转换为 raw 格式。

##### 综合

Sylve 现需 FreeBSD 15.0 或更高版本，因为依赖 Jail 元数据和 ZFS v2.4.0+，其中包含我们依赖的多条命令的 JSON 输出。

平台还进行了大量 UI/UX 改进、性能优化和漏洞修复，包括：

* 使用 [ECharts](https://echarts.apache.org/) 改进图表性能和交互性
* 增强无障碍功能，确保符合 WCAG 标准
* 国际化（i18n）支持，通过 [Wuchale](https://wuchale.dev/) 实现 UI 的印地语（hi）翻译
* 后端优化，加快数据检索并减少加载时间
* 移除若干前端依赖（尤其是 tanstack），采用更轻量替代方案以减小包体积并提高加载速度

#### 路线图更新

部分集群工作仍在进行中。完成后，将发布完整项目文档，并开始打包 Sylve，使其可通过 pkg 简便安装。

我们还在 Sylve 单仓库内开发新的紧密集成备份系统，实现虚拟机、Jails 和配置的简单备份与恢复。
...
联系人：obiwac [[obiwac@FreeBSD.org](mailto:obiwac@FreeBSD.org)](%[5Bobiwac@FreeBSD.org](mailto:5Bobiwac@FreeBSD.org)%5D(mailto:obiwac@FreeBSD.org))

FreeBSD 正在添加挂起到空闲（suspend-to-idle）和 S0ix 睡眠支持。

这将使现代 Intel 和 AMD 笔记本（部分不支持 ACPI S3 睡眠）能够进入低功耗状态，从而延长电池续航。

在 FreeBSD 15 上，Framework 13 AMD Ryzen 7040 系列笔记本现在能半可靠地进入 S0i3。

睡眠类型和 sysctl 代码已提交，并修复了一个回归问题（[D53909](https://reviews.freebsd.org/D53909)）。由于现有 ACPI D 状态代码存在问题，导致某些之前可正常工作的设备无法进入 S3，因此为 S0ix 所需的 D 状态相关提交被回滚，但这些似乎不影响上述机器的 S0i3 进入。已对 D 状态代码进行了清理和修复，但只要不影响目标机器的 S0i3 进入，这不是优先事项。

s2idle 和 SPMC 修订版本（分别为 [D48734](https://reviews.freebsd.org/D48734) 和 [D48387](https://reviews.freebsd.org/D48387)）已审核，并进行了一些准备工作以便提交。已进行新的探索性修订以实现 s2idle 循环（[D54406](https://reviews.freebsd.org/D54406) 和 [D54410](https://reviews.freebsd.org/D54410)）以及必要的调度器更改（[D54407](https://reviews.freebsd.org/D54407) 和 [D54409](https://reviews.freebsd.org/D54409)）。

在从 S0i3 恢复时出现一些问题，似乎仅在加载 USB4 驱动时发生，相关问题已被调查。
...
联系人：Christos Margiolis [[christos@FreeBSD.org](mailto:christos@FreeBSD.org)](%[5Bchristos@FreeBSD.org](mailto:5Bchristos@FreeBSD.org)%5D(mailto:christos@FreeBSD.org))

自 2024 年第一季度以来，我一直在进行音频栈相关工作。以下为之前的状态报告列表：
...
* base 中的 virtual_oss（[更新的发行说明](https://cgit.freebsd.org/src/commit/?id=c457acb4ee821cf015930a94f52c3870786468a7)）。
...
* 提供更多开箱即用的笔记本支持。
* 撰写了 FreeBSD Journal 音频文章。
* 扩展（仍在扩展）`/usr/share/examples/sound`。
...
本报告关注在 FreeBSD 上使用许可宽松的 Linux 无线驱动（大多未修改）以及为原生 net80211 栈准备支持新标准的工作。

#### 驱动更新

由于厂商对 Linux v6.16 的更新在上季度因 drm-kmod 冲突以及随后 Nvidia DRM 问题而停滞，我们在 9 月 15.0-RELEASE 截止前更新到了基于 v6.17 的驱动。不幸的是，多项修复未能及时纳入发布。随后我们还修复了 [graphics/drm-515-kmod](https://cgit.freebsd.org/ports/tree/graphics/drm-515-kmod/) 并修正了 LinuxKPI 代码以恢复 mlx5en 的 SR-IOV 功能。

12 月我们开始跟踪 Linux v6.18 的部分驱动。后续可能直接升级到 v6.19-rcN，以受益于上游改进。

#### 固件

随着驱动更新到新版本，一些固件文件也需要更新。以前用于 [iwlwifi(4)](https://man.freebsd.org/cgi/man.cgi?query=iwlwifi&sektion=4&format=html) 的自动化方法已不再适用，因此我们现在尽量获取所有可用文件，同时尽可能将其分类为不同版本。wifi-firmware ports 框架已完全改为仅提供纯固件文件，不再包含内核模块。这意味着内核更新不再需要升级包，固件可独立更新（大多数情况下）。其他驱动的固件也已更新，无论是否支持。

#### Intel iwlwifi 支持

实现了一些错误修复，主要涉及新版 [iwlwifi(4)](https://man.freebsd.org/cgi/man.cgi?query=iwlwifi&sektion=4&format=html) mvm 子驱动正式拆分为 mvm 与 mld。此外，修复了对 1x1 网卡（如 AX101）的支持问题，该卡在 11n 和 11ac 模式下会发生固件崩溃。

#### Mediatek mt76 芯片组支持

在找到可用于开发的 MT7922 网卡的笔记本（非框架笔记本主 WiFi 插槽）后，10 天内即可实现基本速率数据包传输。mt76 驱动仍受 LinuxKPI `struct page` 冲突和后续 `page pool` 工作阻塞。为 drm-kmod master 分支提交了 pull request，以提前处理 `struct page` 变更可能导致的冲突。工作仍在进行中，以支持 11n 与 11ac 速率。未来将添加更多 mt76 支持的芯片组，可能下一个为 MT7925。

#### Realtek rtw88 与 rtw89 11n 和 11ac 支持

部分 Realtek 芯片组在 LinuxKPI 兼容实现上存在工作或崩溃问题。至少一个 [rtw88(4)](https://man.freebsd.org/cgi/man.cgi?query=rtw88&sektion=4&format=html) 芯片组无法正常关联或扫描，[rtw89(4)](https://man.freebsd.org/cgi/man.cgi?query=rtw89&sektion=4&format=html) 驱动有时会导致内核 panic。相关改进工作正在进行中。同时，正在支持这些驱动的 802.11n 与 802.11ac 速率。BlockACK 支持已完成，[rtw89(4)](https://man.freebsd.org/cgi/man.cgi?query=rtw89&sektion=4&format=html) 接收端表现良好，但发送端仍停留在基础速率，这可能是由于新驱动下行调用导致的，我们现在开始在 LinuxKPI 中支持这些调用以解决问题。
...
联系人：Seyed Pouria Mousavizadeh Tehrani [[info@spmzt.net](mailto:info@spmzt.net)](%[5Binfo@spmzt.net](mailto:5Binfo@spmzt.net)%5D(mailto:info@spmzt.net))

我已从事 GENEVE 隧道实现工作三个月，目前处于审查阶段。GENEVE 在 L3 (IP/UDP) 下层之上为租户系统创建通用网络虚拟化隧道接口，可使用 GENEVE 协议提供第 2 层（以太网）或第 3 层服务。
...
* 编写 [geneve(4)](https://man.freebsd.org/cgi/man.cgi?query=geneve&sektion=4&format=html) 手册页，并更新 [ifconfig(8)](https://man.freebsd.org/cgi/man.cgi?query=ifconfig&sektion=8&format=html) 以包含 geneve 参数。
* 编写测试。

支持 geneve 实现的依赖与相关审查：

* 修复 netlink dump 分配的 Bug [D54190](https://reviews.freebsd.org/D54190)（已完成）
* 修复 netlink 凭证继承的 Bug [54109](https://reviews.freebsd.org/D54109)（审查中）
* 按 RFC6040 更新 ECN 隧道行为（GENEVE 所需）[53516](https://reviews.freebsd.org/D53516)（审查中）

此次审查较大，因为我在提交前已实现其他平台已有的功能。你可以通过在 Phabricator 上审查并提供反馈来加快进程。
...
联系人：Ayrton Muñoz [[a.munoz3327@gmail.com](mailto:a.munoz3327@gmail.com)](%[5Ba.munoz3327@gmail.com](mailto:5Ba.munoz3327@gmail.com)%5D(mailto:a[.munoz3327@gmail.com](mailto:.munoz3327@gmail.com)))

我一直在为内核添加 Rust 支持，并尝试使用 Rust 编写设备驱动。Rust 可以通过类型系统强制执行关于指针使用的规则，而这些规则在 C 中通常是隐含的，需要开发者额外的心智负担。Rust 并不能防止所有错误，但它可以帮助开发者减少这些负担，更专注于实现核心功能。

Rust KPI 当前仍在开发中，尚不稳定，但它们不依赖于更广泛的 Rust 生态系统或不稳定语言特性/API。这意味着它们最终应能提供与 C KPI 等效的稳定性，升级到新 Rust 工具链不应引入破坏性变更。它也提供与 C 同等的透明度，明确何时发生分配，因为使用的是非分配子集的 [Rust 标准库](https://doc.rust-lang.org/core/)。不同内核子系统可能需要 Rust 封装，但这些可以基于 rust KPI 仓库提供的基础功能构建。

自 2024 年末以来，我零散地进行实验开发，主要在 rust KPI 仓库中进行。该仓库还提供了用于 [config(8)](https://man.freebsd.org/cgi/man.cgi?query=config&sektion=8&format=html) / 构建系统集成的 Makefile 和补丁。对开发者而言，最容易构建和尝试的驱动是我的 [virtio 声卡驱动](https://github.com/ayrtonm/freebsd-src/tree/virtio_snd)。部分接口仍在变化，但该驱动已足够在 [QEMU](https://www.qemu.org/docs/master/system/devices/virtio/virtio-snd.html) 中播放音乐。该分支还包含可复用的 Rust 封装，可用于其他 virtio 设备或声卡/PCM 驱动。
...
预计到 2026 年初，Rust KPI 将足够稳定，供开发者尝试编写新代码。它们不会完美，但会尽量兼容现有驱动的期望，并符合 Rust 开发者的使用习惯。同时，Apple 驱动预计在 2026 年上半年恢复到最初 C WIP 的功能水平。

### USB 内核调试改进

联系人：Tom Jones [[thj@FreeBSD.org](mailto:thj@FreeBSD.org)](%[5Bthj@FreeBSD.org](mailto:5Bthj@FreeBSD.org)%5D(mailto:thj@FreeBSD.org))

XHCI USB 控制器提供一种模式，可作为系统调试接口使用。XHCI 调试模式使用特殊的 USB 3 数据线，其中 VBUS、D+ 和 D- 被断开。该功能可用于对 FreeBSD 内核进行实时调试，用于排查导致系统视频控制台锁死的问题，而没有可替代方案（如串口控制台）时尤其有用。例如在调试图形驱动问题时可能出现这种情况。
...
本季度，对 XHCI 调试主机端接口进行了大量调试工作。设计了一个定制板，支持 USB-C 的两种调试模式：XHCI 调试和 USB-C 调试配件模式（DAM）。DAM 为 USB-C 接口提供替代模式，在部分设备（如 2025 Framework 笔记本和桌面机）上，该模式可访问 SOC UART 进行调试。

为了完成完整的 XHCI USB-C 适配器和更完整的 DAM 适配器，仍需进一步硬件改进。

加载器部分的实现已创建评审，并提取了若干更改，已合并入源码树。
...
更新平台特定功能，并增加对新硬件平台的支持。

### BananaPi-R64 FreeBSD 驱动开发

链接：
[Wiki](https://wiki.freebsd.org/arm/Bananapi) URL: [https://wiki.freebsd.org/arm/Bananapi](https://wiki.freebsd.org/arm/Bananapi)

联系人：Martin Filla [[freebsd@sysctl.cz](mailto:freebsd@sysctl.cz)](%[5Bfreebsd@sysctl.cz](mailto:5Bfreebsd@sysctl.cz)%5D(mailto:freebsd@sysctl.cz))

#### 简介

Banana Pi R64 是基于 MediaTek MT7622 的开发板（ARM Cortex-A53，双核约 1.35 GHz），配备 4× 千兆 LAN、1× 千兆 WAN、Wi-Fi（4×4n）、Bluetooth 5.0，以及多种外设接口（UART、SPI、I²C、GPIO、SATA、mini-PCIe、eMMC 等）。
...
联系人：
FreeBSD 可访问性邮件列表 [[freebsd-accessibility@FreeBSD.org](mailto:freebsd-accessibility@FreeBSD.org)](%[5Bfreebsd-accessibility@FreeBSD.org](mailto:5Bfreebsd-accessibility@FreeBSD.org)%5D(mailto:freebsd-accessibility@FreeBSD.org))
Alfonso Sabato Siciliano [[asiciliano@FreeBSD.org](mailto:asiciliano@FreeBSD.org)](%[5Basiciliano@FreeBSD.org](mailto:5Basiciliano@FreeBSD.org)%5D(mailto:asiciliano@FreeBSD.org))

近期报告中，新版可访问性手册已发布并完成评审。该手册旨在记录 FreeBSD 中可用的辅助技术，涵盖基础系统和 Ports Collection。

本季度工作：

* 手册在 FreeBSD Developer Summit Zagreb 2025 上进行了展示，幻灯片见 [此处](https://docs.google.com/presentation/d/1rnw5fU8KyUCGNqR6gkM5IBdyx8cVVdqigCGmrrd%E2%80%94%E2%80%8Ba4)。
...
当前手册主要描述视觉障碍相关的辅助技术，是 FreeBSD Foundation 赞助的 Vision Accessibility 项目的一部分。手册结构为两部分、六章：

1. **帮助（Help）** — 介绍如何通过适当的 FreeBSD 沟通渠道有效请求帮助。
2. **虚拟终端（Virtual Terminal）** — 记录 FreeBSD 虚拟控制台（[vt(4)](https://man.freebsd.org/cgi/man.cgi?query=vt&sektion=4&format=html)）的视觉可访问性功能。
3. **颜色（Colors）** — 解释如何配置颜色方案，包括高对比度主题和环境光调节屏幕颜色。
...
手册故意避免使用图片，尽量减少非纯文本元素，以提高与辅助技术的兼容性。欢迎提供建议和新思路，可将反馈发送至 FreeBSD 可访问性邮件列表，以便公开讨论和跟踪。
...
联系人：
Graham Percival [[gperciva@tarsnap.com](mailto:gperciva@tarsnap.com)](%[5Bgperciva@tarsnap.com](mailto:5Bgperciva@tarsnap.com)%5D(mailto:gperciva@tarsnap.com))

FreeBSD Git 每周更新提供 [FreeBSD 源码树](https://cgit.freebsd.org/src/) 的提交列表，按“文档”、“硬件支持”、“测试”和“内核”等类别分类。对于希望一次性查看三个月开发情况的用户，也提供季度汇总。
...
联系人：
Andrey Zakhvatov [[andy@FreeBSD.org](mailto:andy@FreeBSD.org)](%[5Bandy@FreeBSD.org](mailto:5Bandy@FreeBSD.org)%5D(mailto:andy@FreeBSD.org))
Vladlen Popolitov [[vladlen@FreeBSD.org](mailto:vladlen@FreeBSD.org)](%[5Bvladlen@FreeBSD.org](mailto:5Bvladlen@FreeBSD.org)%5D(mailto:vladlen@FreeBSD.org))

FreeBSD 俄语文档项目旨在为 FreeBSD 提供最新的俄语翻译，包括 FAQ、手册和网站内容，以支持俄语用户并提升全球操作系统的使用率。

上季度工作成果：

* Weblate 中的所有文本已完成翻译，覆盖所有近期变更。
* 剩余文档的审查与更新已完成，47 个文档（书籍和文章）均已在 [俄语文档站点](https://docs.freebsd.org/ru/) 同步。
* [www.FreeBSD.org/ru](https://www.freebsd.org/ru) 的俄语版已恢复，约 90% 页面已更新。
* 新闻、活动公告及媒体链接均已翻译并发布；2025 年 1 月起，Errata 通告和安全公告也开始提供俄语版。
...
* 完成俄语网站剩余页面更新。
* 建立可持续工作流程，确保翻译内容（新闻、活动、媒体、Errata、安全公告）及时更新并发布。
...
影响 Ports Collection 的更改，包括影响整个树的重大调整或单个端口的更新。
...
联系人：Generic Rikka [[rikka.goering@outlook.de](mailto:rikka.goering@outlook.de)](%[5Brikka.goering@outlook.de](mailto:5Brikka.goering@outlook.de)%5D(mailto:rikka[.goering@outlook.de](mailto:.goering@outlook.de)))

本季度，主要工作集中在使 FreeBSD 成为现代 HPC 集群的实际目标，通过更新 Slurm + PMIx + PRRTE 栈的关键组件，使其作为一级 Ports 可用。

#### 已完成工作

* 将 [sysutils/slurm-wlm](https://cgit.freebsd.org/ports/tree/sysutils/slurm-wlm/) 从 23.11.7 更新至 25.11.0，跟踪上游最新长期维护系列，大幅减少 FreeBSD 所需的本地补丁数量。
* 更新 Slurm rc.d 脚本，使 `slurmctld` 和 `slurmd` 更好地整合到典型 FreeBSD 部署中（可配置的配置/日志目录、pid 文件、状态和清理助手）。
* 引入 [net/pmix](https://cgit.freebsd.org/ports/tree/net/pmix/) 和 [net/prrte](https://cgit.freebsd.org/ports/tree/net/prrte/) 作为独立端口，并将 [net/openmpi](https://cgit.freebsd.org/ports/tree/net/openmpi/) 改为使用这些独立运行时，而非 OpenMPI 自带的副本，使 FreeBSD 与许多 Linux HPC 发行版的 MPI 运行时分发方式更加一致。
* 添加 [sysutils/py-clustershell](https://cgit.freebsd.org/ports/tree/sysutils/py-clustershell/)，一个广泛用于可扩展集群管理的 Python 框架，为 FreeBSD 用户提供与生产 HPC 系统常用工具一致的体验。

#### 进行中的工作

* 对 Slurm 的额外集成改进进行迭代（插件、默认配置、文档），以便在真实集群中更容易部署 Slurm。
* 扩展 HPC 用户态栈，引入更多工具，如测试框架和面向作业的实用程序，使 FreeBSD 可作为 HPC 软件开发和验证的现实平台。
* 移植 [sysutils/mpifileutils](https://cgit.freebsd.org/ports/tree/sysutils/mpifileutils/) 及其依赖项（[devel/libcircle](https://cgit.freebsd.org/ports/tree/devel/libcircle/)、[devel/lwgrp](https://cgit.freebsd.org/ports/tree/devel/lwgrp/)、[devel/lwgrpd](https://cgit.freebsd.org/ports/tree/devel/lwgrpd/)），提供大规模 HPC 文件系统常用的 MPI 并行文件工具（当前审查中）。
...
* 识别并解决 FreeBSD 特有的缺陷或回归，确保软件栈在 FreeBSD 上保持功能完整且稳健。
...
联系人：Lorenzo Salvadore [[salvadore@FreeBSD.org](mailto:salvadore@FreeBSD.org)](%[5Bsalvadore@FreeBSD.org](mailto:5Bsalvadore@FreeBSD.org)%5D(mailto:salvadore@FreeBSD.org))

本季度 FreeBSD 上的 GCC 几乎没有变化。

主要新闻是 [将 GCC 默认版本从 13 更新到 14 的 exp-run](https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=281091) 最终完成了。由于在最新 FreeBSD 版本上 emacs ports 中发生的一些 segmentation fault，这一过程比预期耗时更长。由于 GCC_DEFAULT 更新已经拖延很久，因此选择暂时将 emacs ports 固定在 GCC 13，以便这个单一的 bug 不会阻止 ports 树的其他部分默认使用更新的 GCC 版本。更多信息请参见 [PR 288303](https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=288303)。

GCC 15 已经在我们的 ports 树中，GCC_DEFAULT 更新到 15 的过程将很快开始。
...
联系人：Roman Bogorodskiy [[novel@FreeBSD.org](mailto:novel@FreeBSD.org)](%[5Bnovel@FreeBSD.org](mailto:5Bnovel@FreeBSD.org)%5D(mailto:novel@FreeBSD.org))
...
联系人：
Harald Eilertsen [[haraldei@FreeBSD.org](mailto:haraldei@FreeBSD.org)](%[5Bharaldei@FreeBSD.org](mailto:5Bharaldei@FreeBSD.org)%5D(mailto:haraldei@FreeBSD.org))
FreeBSD Java 邮件列表 [[freebsd-java@lists.freebsd.org](mailto:freebsd-java@lists.freebsd.org)](%[5Bfreebsd-java@lists.freebsd.org](mailto:5Bfreebsd-java@lists.freebsd.org)%5D(mailto:freebsd-java@lists.freebsd.org))
...
* 发布了 OpenJDK 25 的 port，[随后更新至 OpenJDK 25.0.1](https://reviews.freebsd.org/D53975)。感谢 Greg Lewis 和 Kurt Miller 的帮助。
* 为 OpenJDK 25 port 添加了 [`headless` 和 `jre` FLAVORS](https://kodeknekkeriet.net/en/blog/introducing-flavors-in-openjdk-freebsd/)。这允许只构建和安装无 GUI 的 JDK 或仅 Java Runtime Environment（无编译器或开发工具）。也可以组合使用，仅安装 `headless-jre` 变体。这在服务器环境或资源受限环境中非常有用，在这些环境中无需完整的 JDK 和工具。计划将这些 FLAVORS 扩展到其余 OpenJDK ports。
...
* 弃用上游 [不再支持的 OpenJDK ports](https://reviews.freebsd.org/D54176)。这些 ports 将在 2026 年上半年逐步过期并移除，仅保留 LTS 版本和最新维护的 ports。
...
* 重新启动了在 ports 系统中更改 OpenJDK 构建引导方式的工作。由于弃用未维护的 ports 打破了依赖前一个 OpenJDK 版本构建当前版本的假设，这项工作再次显得重要。新的引导机制必须在现有 ports 过期前到位。
...
联系人：Ronald Klop [[ronald@FreeBSD.org](mailto:ronald@FreeBSD.org)](%[5Bronald@FreeBSD.org](mailto:5Bronald@FreeBSD.org)%5D(mailto:ronald@FreeBSD.org))
...
联系人：FreeBSD 上的 KDE 邮件列表 [[kde@FreeBSD.org](mailto:kde@FreeBSD.org)](%[5Bkde@FreeBSD.org](mailto:5Bkde@FreeBSD.org)%5D(mailto:kde@FreeBSD.org))
...
随着 KDE Gear 25.12.0，最后两个应用程序最终迁移至 Qt6，KDE 栈已不再依赖 Qt5 包。[x11/kde](https://cgit.freebsd.org/ports/tree/x11/kde/) port 已缩减，不再为 Qt5 和 GTK2 应用安装 Plasma 6 集成插件。如果需要，仍可通过 [x11/plasma6-plasma](https://cgit.freebsd.org/ports/tree/x11/plasma6-plasma/) port 安装。

Plasma/Wayland 的支持得到改进，可作为日常驱动替代 Plasma/X11 使用。

#### 相关 Ports

[KDE 团队](mailto:kde@FreeBSD.org) 维护近 730 个 ports，并根据需要进行更新。根据 [portscout](https://portscout.freebsd.org/kde@freebsd.org.html)，仅有 1% 的 ports 已过时。
...
MongoDB 是生产级 NoSQL 数据库。我们的 ports 已经提供 MongoDB 社区版多年。MongoDB 被 ports 中的多个 WiFi 控制器软件使用，如 Unifi 和 Omada。在 MongoDB 8.0.13 中，构建系统从 SCons 改为 Bazel。
...
联系人：Puppet 团队 [[puppet@FreeBSD.org](mailto:puppet@FreeBSD.org)](%[5Bpuppet@FreeBSD.org](mailto:5Bpuppet@FreeBSD.org)%5D(mailto:puppet@FreeBSD.org))
...
今年 Puppet 领域发生了许多变化。Perforce [宣布其对开源贡献的重大变更](https://www.puppet.com/blog/open-source-puppet-updates-2025) 后，终止了 Puppet 开源版本（OSS Puppet），建议用户切换到 Puppet Enterprise（长期存在的闭源版本）或 Puppet Core（新的闭源版本，不公开开发，[仅在签署最终用户许可协议（EULA）后可访问](https://voxpupuli.org/blog/2025/05/19/perforce-eula/)）。Vox Pupuli 社区尝试与 Perforce 协商，但未成功。因此，Vox Pupuli 接管了 Apache-2.0 授权的 Puppet 代码的维护，继续更新、提供包，而不再依赖 Perforce。由于 “Puppet” 名称属于 Perforce，该项目重命名为 “OpenVox”，以避免用户将旧未维护的开源 Puppet 与 OpenVoxProject 维护的新版本混淆。

为配合这些变化，FreeBSD ports 树添加了多个 ports：
...
它们是旧 ports 的直接替代：虽然软件包名为 “openvox”，服务名称暂时保持不变。切换只需安装它们，并在 pkg 提示移除旧软件包并安装新软件包时选择是。无需其他操作：之前使用 Puppet 的模块应继续在 OpenVox 上工作。

今年 Puppet 7 已达到生命周期终点，对应 ports 已从 FreeBSD ports 树中删除。Puppet 7 是最后一个允许在 C 版本与 Ruby 版本 facter 之间选择的版本，因此 C 版本 port ([sysutils/facter](https://cgit.freebsd.org/ports/tree/sysutils/facter/)) 也被删除。由于 Puppet 8 的旧 ports 不再更新，它们很快将被弃用，并遵循同样的命运。
