...
2004 年继续取得显著进展。网络栈锁定工作继续进行，ACPI（高级配置与电源接口）取得了巨大进展，ARM 平台出现在代码库中，FreeBSD 4.10 发布周期也已完成。待 4.10 发布，接下来的重点将是 FreeBSD 5.3。我们预计这将是 5-STABLE 分支的开始，这意味着它不仅会稳定适用于生产环境，还将在内部 API 方面大体上功能完整且稳定。我们预计将在夏季中旬发布 5.3 版，并鼓励大家从 **ftp://snapshots.jp.FreeBSD.org** 下载最新的快照版本以预览。
