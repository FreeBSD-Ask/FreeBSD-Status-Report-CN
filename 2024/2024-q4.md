...
以下是 2024 年的第四份也是最后一份状态报告，共包含 44 项内容。  

它展示了：2024 年是一个极其成功且繁忙的一年。通常来说，年末几个月的工作节奏会有所放缓，因为人们会去度假并庆祝新年。然而，我们依然在众多事务上取得了巨大进展，并成功交付了诸多成果！  

整理和编写这份报告花费的时间比预期更长，但等待是值得的。  

感谢整个社区的卓越工作，特别感谢那些为本报告提供更新的贡献者！  
...
来自各个官方和半官方团队的条目，可在 [管理页面](https://www.freebsd.org/administration/) 找到。  
...
核心团队于 2024 年 12 月 12 日与 FreeBSD 基金会进行了视频会议，以跟进他们在 EuroBSDCon 期间于都柏林举行的线下会议。核心团队与基金会继续探讨如何加强合作，并支持开发者和贡献者：  
...
FreeBSD 基金会是一家 501(c)(3) 非营利组织，致力于通过技术和非技术支持推动 FreeBSD 的发展。基金会完全由捐赠资助，支持软件开发、基础设施、安全及协作工作；组织活动和开发者峰会；提供教育资源；并在法律事务中代表 FreeBSD 项目。本报告涵盖了 2024 年第四季度基金会支持 FreeBSD 的部分工作。  

我是 Deb Goodkin，在此代表基金会，首先要感谢这个了不起的社区！正是由于大家的财务支持，我们才能承担起一些重要项目，包括大规模、多阶段的软件开发工作、更深入的安全改进，以及将持续至 2025 年的重要基础设施改进。此外，我们还加大了 FreeBSD 的推广力度，涵盖了多个技术和社交媒体平台，并制作了更多内容来宣传和推广 FreeBSD。更多相关信息，请见下文。如果想深入了解我们在 2024 年的工作，请查看年底博客文章以及我在推广部分的年度回顾。  

我们正在招聘！请查看我们的[职位页面](https://freebsdfoundation.org/open-positions/)，目前有解决方案专家（Solutions Specialist）和技术营销经理（Technical Marketing Manager）的职位空缺。此外，我们也在寻找兼职技术写作人员，并将很快开放另一个职位，敬请关注。  

我们仍在最终确认 2024 年的筹款总额，截至目前，我们已筹集约 $1,324,000。你可能会想：既然已经是 2025 年了，为什么还没有最终统计数据？首先，我们尚未收到所有 2024 年邮寄的支票。此外，我们仍在等待一些去年开具发票的付款。最终报告将在下个季度的状态报告中公布。  

感谢在第四季度提供财务支持的个人和机构！我们共收到 325 笔个人捐赠，总额为 $120,841，以及来自 6 家机构的财务支持，总计 $326,000。此外，我们还获得了硅谷社区基金（Silicon Valley Community Fund）的拨款。  

此外，我要特别感谢一位匿名捐赠者，他希望我们帮助开发者获取 Framework 笔记本电脑。Pietro Cerutti 一直在协调这项工作，目前我们已接近与 Framework 公司敲定流程，以便开发者能够直接向他们下单。  

我们还为 BSDCon AV 团队资助了近 $5,000 的音视频设备，以减少每次 BSD 主要会议所需租赁的设备数量。  

回到财务状况方面，我们将在 2024 年第一季度发布财务文件和报告。2024 年第一至第三季度的更新财务报告将在 1 月底发布，以更好地匹配预算格式。最终的 2024 年财务报告将在 2024 年第二季度初发布。未来，我们的预算和财务报告将更详细地说明资金如何分配给主要的软件开发项目。例如，我们会包括每季度在笔记本电脑项目上的支出。我们正在与会计师合作，以改进我们的会计系统，使资金使用情况更加透明。  

我们对 2025 年及未来 FreeBSD 的发展机遇感到兴奋，并正在扩展团队，以支持抓住这些机遇所需的工作。然而，我们需要你的帮助来维持这一切。我们的投资最多只能支撑一年或两年。如果你的公司希望 FreeBSD 长期保持可持续发展，请考虑提供财务支持，以确保它继续成为你所依赖的安全、可靠和创新的平台。不知道该如何申请资助？请联系我们，我们可以帮助你完成流程。  

请访问 [https://freebsdfoundation.org/donate/](https://freebsdfoundation.org/donate/) 进行捐赠。  
想了解我们的合作伙伴计划，请访问 [https://freebsdfoundation.org/our-donors/freebsd-foundation-partnership-program/](https://freebsdfoundation.org/our-donors/freebsd-foundation-partnership-program/)。

#### 推广  

在 2024 年第四季度，我们继续提高 FreeBSD 的知名度，宣传该项目，展示用户案例，并为 FreeBSD 社区提供教育内容。以下是一些重要工作概述：  

* 赞助并协助组织了 [2024 年秋季 FreeBSD 峰会](https://freebsdfoundation.org/news-and-events/event-calendar/fall-2024-freebsd-summit/)，该活动于 2024 年 11 月 7 日至 8 日在加州圣何塞举行。请查看[活动回顾](https://freebsdfoundation.org/blog/reflecting-on-the-fall-2024-freebsd-summit-insights-and-innovations/)。相关视频可在 [FreeBSD YouTube 频道](https://youtube.com/playlist?list=PLugwS7L7NMXwhtfVdd3m2Ro0TV1XDzl3t&si=FjFDkeaiXqRKS1Lq)观看。  
* 向社区介绍了两个新版本的最新动态：  
...
* 发行了 [2024 年 9 月/10 月](https://freebsdfoundation.org/our-work/journal/browser-based-edition/kernel-development/) 的 FreeBSD 期刊，并提供 HTML 版本的文章。

#### 操作系统改进

在 2024 年第四季度，共有 382 个 `src`、135 个 `ports` 和 17 个 `doc` 树提交标注了 FreeBSD 基金会作为赞助方。

基金会及其投资合作伙伴支持了四个主要项目：

* [Konstantin Belousov](mailto:kib@FreeBSD.org) 继续开发 FreeBSD 的 AMD IOMMU 驱动程序，该项目由 AMD 和基金会共同资助。此项工作旨在增强对多核 AMD 系统以及其他需要中断重映射的场景的支持。该驱动程序已于 11 月初[推送至 src 树](https://cgit.freebsd.org/src/commit/?id=0f5116d7efe33c81f0b24b56eec78af37898f500)，并持续进行测试和优化。
* [Alpha-Omega](https://alpha-omega.dev/) 和基金会共同资助了一个 FreeBSD 安全性改进项目。最新进展请参阅 [FreeBSD 基金会的安全工程](https://www.freebsd.org/status/report-2024-10-2024-12/#_security_engineering_at_the_FreeBSD_Foundation)报告条目。
* 本季度启动了一项[提升 FreeBSD 笔记本电脑可用性的项目](https://freebsdfoundation.org/blog/why-laptop-support-why-now-freebsds-strategic-move-toward-broader-adoption/)。详情请参阅 [笔记本电脑支持和可用性改进项目](https://www.freebsd.org/status/report-2024-10-2024-12/#_laptop_support_and_usability_improvements_project)报告条目。
...
* [Alfonso S. Siciliano](mailto:asiciliano@FreeBSD.org) 提供了 [FreeBSD 无障碍项目更新](https://www.freebsd.org/status/report-2024-10-2024-12/#_ports_collection_accessibility_colors_low_vision)。
...
* [Bjoern A. Zeeb](mailto:bz@FreeBSD.org) 分享了 [LinuxKPI 802.11 无线更新](https://www.freebsd.org/status/report-2024-10-2024-12/#_linuxkpi_802_11_wireless_update)。
...
* [Christos Margiolis](mailto:christos@FreeBSD.org) 分享了 [FreeBSD 音频栈改进](https://www.freebsd.org/status/report-2024-10-2024-12/#_audio_stack_improvements) 的最新进展。
...
* [Joseph Mingrone](mailto:jrm@FreeBSD.org) 个人花时间[改进 ports 树中的 Common Lisp 支持](https://www.freebsd.org/status/report-2024-10-2024-12/#_improving_common_lisp_infrastructure_in_freebsd_ports)。
* [Olivier Certner](mailto:olce@FreeBSD.org) 提交了一份报告，描述了他与 Baptiste Daroussin 一起完成的[使用 MAC 框架实现受控进程凭据转换](https://www.freebsd.org/status/report-2024-10-2024-12/#_mac_do4_setcred2_mdo1)的工作。
...
* 在 ports 树方面，[Muhammad Moinur Rahman](mailto:bofh@FreeBSD.org) 将 `USE_OCAML` 和 `USE_JAVA` 转换为 `USES` 框架。
...
作为我们对 FreeBSD 项目的持续支持的一部分，基金会支持一名全职工作人员，专门负责[改进项目的持续集成系统和测试基础设施](https://www.freebsd.org/status/report-2024-10-2024-12/#_ci)。

#### 法务 / FreeBSD 知识产权

基金会拥有 FreeBSD 商标，并负责其保护工作。同时，我们还为核心团队提供法律支持，以调查和解决出现的相关问题。

请访问 [https://freebsdfoundation.org](https://freebsdfoundation.org/) 了解我们如何支持 FreeBSD 以及如何为您提供帮助！
...
链接：
[FreeBSD 14.2-RELEASE 公告](https://www.freebsd.org/releases/14.2R/announce/) URL：[https://www.freebsd.org/releases/14.2R/announce/](https://www.freebsd.org/releases/14.2R/announce/)  
[FreeBSD 13.5-RELEASE 计划](https://www.freebsd.org/releases/13.5R/schedule/) URL：[https://www.freebsd.org/releases/13.5R/schedule/](https://www.freebsd.org/releases/13.5R/schedule/)  
[FreeBSD 发行版本](https://download.freebsd.org/releases/ISO-IMAGES/) URL：[https://download.freebsd.org/releases/ISO-IMAGES/](https://download.freebsd.org/releases/ISO-IMAGES/)  
...
FreeBSD 发行工程团队负责制定和发布 FreeBSD 官方项目版本的发布计划，宣布代码冻结，并维护相关分支等工作。
...
除了以往发布的 ISO 和 U 盘镜像、VM 镜像、云端映像等，团队现在还提供兼容 OCI（开放容器标准）的容器镜像。
...
除软件包构建服务器和面向开发者的 "dogfood" 机器外，FreeBSD 集群大多运行 stable/X 分支。

截至撰写本文时，集群中共有 131 台物理机器。其中，54 台运行 current，61 台运行 stable/14，14 台运行 stable/13。目前正在将剩余的 stable/13 机器升级至 stable/14。而 stable/12 机器已经被列入退役计划，它们不再运行生产环境工作负载。剩余的机器计划在近期升级或退役。
...
今年早些时候，我们开始在芝加哥建立新的站点。本季度，我们开始退役位于新泽西的旧服务器，并将服务迁移到芝加哥的新服务器。我们的长期目标是让芝加哥成为主要站点。这项工作仍需几个月才能完成。

#### FreeBSD 官方镜像概览

当前镜像站点包括：澳大利亚、巴西、德国、日本（两个完整镜像站点）、马来西亚、南非、瑞典、台湾、英国（完整镜像站点）、美国（加利福尼亚、芝加哥、新泽西〔主站点〕和华盛顿）。

我们的台湾镜像站点正经历长时间的宕机，预计将在 2025 年第一季度恢复上线。

此外，我们预计在 2025 年第一季度于加利福尼亚新增一个镜像站点，由 [Sonic](https://sonic.net/) 慷慨提供托管支持。
...
我们始终欢迎新增官方镜像站点。全球范围内在互联网交换中心（IXP）托管单独的镜像站点已被证明具有显著优势，例如我们在澳大利亚、巴西和南非的现有镜像站点。如果您所属或了解任何愿意赞助单独镜像服务器的机构，请联系我们。我们尤其希望在美国西海岸和欧洲各地拓展新的镜像站点。

有关完整镜像站点的规格，请参阅 [通用镜像布局](https://wiki.freebsd.org/Teams/clusteradm/generic-mirror-layout)，有关单独镜像站点的信息，请参阅 [tiny-mirror](https://wiki.freebsd.org/Teams/clusteradm/tiny-mirror)。
...
[FreeBSD CI 构建产物存档](https://artifact.ci.freebsd.org/) URL: [https://artifact.ci.FreeBSD.org](https://artifact.ci.freebsd.org/)  
...
[FreeBSD CI 代码仓库](https://github.com/freebsd/freebsd-ci) URL: [https://github.com/freebsd/freebsd-ci](https://github.com/freebsd/freebsd-ci)  
...
**Ports 管理团队** 负责监督 **Ports 树** 的整体方向、软件包构建及相关人员事务。以下是上季度的相关情况。  

在上个季度，我们欢迎 **Xavier Beaudouin (kiwi@)** 成为新的 Ports 提交者。  

根据 **INDEX** 数据，目前 **Ports 集合** 中共有 **36,332** 个软件包（较上一季度的 **36,504** 个有所减少）。目前约有 **3,368** 个开放的 **Ports PR**（较上一季度的 **3,379** 个减少），其中 **809** 个尚未分配。  

上个季度，**main** 分支共有 **10,640** 次提交（较上一季度的 **11,594** 次减少），由 **155** 名提交者完成（比上一季度少 1 名）。**2024Q4** 分支共有 **733** 次提交（较上一季度的 **832** 次减少），由 **61** 名提交者完成（较上一季度的 **78** 名减少）。  
...
在上个季度，**pkgmgr@** 团队进行了 **14 次实验性构建（exp-run）**，以测试 **各类 Ports 升级** 及对 `bsd.port.mk` 的改动。
...
Mark Linimon 参与了多次与 src 提交者的视频会议。目前，他们正在进行一些实验，以了解哪些工作流程是可持续的。最近的一项工作是评估最新提交的 src PR，你会注意到，过去几周的许多 PR 都被标记为请求反馈。

此外，Bugmeister 团队对 Bugzilla 数据库进行了元数据清理，具体包括：

* 重新分配 Bug，避免其指派给提交权限已被保留（safekept）的一年期内未活跃的开发者。
* 清理 `Base` 系统的 `In Progress` 状态 Bug，其中许多未被积极处理，目前数量降至 184。
...
* 评估 `mfc-stableN` 相关 PR，特别是 `mfc-stable12` 相关 PR 已清除该标记。
  * 目的是确保元数据具有实际意义，比如："某个提交已经完成，并需要评估是否需要 MFC"。
  * 目前，这类 PR 的数量已大幅减少。
* 关闭大量 PR，标记为 "Overcome By Events"（已被事件取代），主要依据：
  * 旧版本 + 包含 "boot" 关键字
  * 旧版本 + 包含 "alpha" 或 "beta" 关键字
* 评估 "PR 显示已提交"（可能是通过 Phabricator）但没有后续讨论的 PR。
  * 对于部分 PR，我们直接将其指派给相关开发者，并确保 mfc-stable[13|14] 标记已正确设置。
  * 仍然有许多 PR 已有提交，但后续仍有讨论，这类 PR 可能需要更多志愿者来整理。
* 移除许多 PR 中的 "patch" 关键字。
  * 最佳情况下，补丁信息应通过附件的元数据自动推断。
  * 如果补丁是以内联文本方式提交，而非附件，则 "patch" 关键字仍会保留。一些遗留的 GNATS 转换数据可能仍然包含此类内联补丁，但应尽量避免使用它们，因为自动化工具无法检测内联补丁。感谢我们的 triagers，特别是 Alexander Ziaee。

关于 Bugzilla 未来的讨论  
在最近的一些视频会议中，我们讨论了 Bugzilla 的未来发展。目前，Phabricator 已停止维护，但其支持的继任者已经出现。多个团队将需要协调，以评估新工具的适用性。
...
新增 Triage 成员  
我们欢迎 Lexi（Discord ID: ivy）加入 Triage 团队。

此外，glebius 已被添加到 bugmeister@ 别名，作为 core.13 的联络人。
...
联系方式:  
srcmgr <[srcmgr@FreeBSD.org](mailto:srcmgr@FreeBSD.org)>

一个新的 [源代码管理团队](https://www.freebsd.org/administration/#t-srcmgr) 已由 core@ 批准成立，负责管理 FreeBSD 源代码树，类似于 portmgr@ 和 doceng@ 分别负责管理 Ports 和文档树。最初的团队成员包括 Ed Maste、Mark Johnston、John Baldwin 和 Warner Losh。srcmgr@ 目前的重点是寻找提高源代码开发者工作效率的方法，并尝试管理大量的错误报告和拉取请求（PR）。团队每两周举行一次会议，讨论与源代码相关的问题，并花时间处理错误报告和拉取请求。[会议纪要](https://github.com/freebsd/meetings/tree/master/srcmgr) 可在 GitHub 上查看。srcmgr@ 团队有一个 [章程](https://www.freebsd.org/srcmgr/charter/)，并正在开发和记录帮助管理源代码树的政策。

在 2024 年 12 月，srcmgr@ 举办了一次在线的错误修复活动，共有 15 名开发者参与。我们花时间回顾了最近的错误报告，以及带有补丁的旧报告。团队计划每月举办此类活动，并希望未来向更广泛的观众开放。

团队计划在 2025 年上半年开发一个类似于 portmgr@ 的潜伏者计划。
...
该项目始于 2024 年第三季度，由主权技术机构委托，预算为 745,000 美元，计划在大约一年内完成。主要目标是提升基础系统、Ports 和软件包的安全工具，更新项目的基础设施以加速开发，增强构建安全性，并简化新开发者的入门过程。

第四季度更新：

* 工作包 A：技术债务减少。基金会与源代码管理团队合作，委托并部署了多个仪表板，用于描述 FreeBSD 项目的错误积压情况。这些仪表板由我们的项目合作伙伴 Bitergia 使用开源工具 GrimoireLab 创建，并按照团队的规格设计。基金会工作人员将这些仪表板托管在 FreeBSD 部署上，访问地址为 [https://grimoire.freebsd.org/](https://grimoire.freebsd.org/)。关于仪表板的更多信息可以在 [https://github.com/freebsd/grimoire](https://github.com/freebsd/grimoire) 上找到。  
  源代码管理团队还使用这些仪表板支持他们的新方法来处理错误报告，这些仪表板已成为协作修复错误活动的关键工具。
* 工作包 B：零信任构建，工作包 C：CI/CD 自动化。基金会与 FreeBSD 项目内的各个关键管理和管理团队合作，共同创建了这两个项目的范围细节。计划于 1 月开始，并将在第二季度或第三季度结束。
...
该项目始于 2024 年第四季度，由 FreeBSD 基金会和 Quantum Leap Research 资助。项目预算为 750,000 美元，计划在一到两年内使用。项目的目标是改善 WiFi、音频可用性、挂起和恢复功能、图形和蓝牙等关键功能。团队还将创建清晰的文档和逐步指南，帮助用户使用新功能。

第四季度更新：

* 基金会 [启动了该项目](https://freebsdfoundation.org/blog/why-laptop-support-why-now-freebsds-strategic-move-toward-broader-adoption/)，创建了 [公开路线图](https://github.com/FreeBSDFoundation/proj-laptop)，并分配了承包商到相关工作流。12 月是首次开发迭代，涵盖了以下内容：
  ...
  * [wireless_update，基于 OpenBSD/Haiku 的 Intel WiFi 接口 POC 驱动程序](https://github.com/FreeBSDFoundation/proj-laptop/issues/45)
  * [解决 pkg 中的技术债务，以启用 PkgBase 开发](https://github.com/FreeBSDFoundation/proj-laptop/issues/46)
  ...
  * [引入戴尔的相机代码捐赠](https://github.com/FreeBSDFoundation/proj-laptop/issues/39)
* FreeBSD 项目启动了一个名为 [“笔记本电脑和桌面工作组” (LDWG)](https://wiki.freebsd.org/LaptopDesktopWorkingGroup) 的社区小组，旨在帮助从事与笔记本电脑和桌面相关项目的人员与社区中从事类似工作的其他人联系和合作。该小组在 2024 年 12 月举行了首次月度会议。要了解 LDWG 活动的最新动态，可以 [加入桌面邮件列表](https://lists.freebsd.org/subscription/freebsd-desktop)。
...
链接：  
[FreeBSD 基金会发布由 Alpha-Omega 项目资助的 Bhyve 和 Capsicum 安全审计](https://freebsdfoundation.org/news-and-events/latest-news/freebsd-foundation-releases-bhyve-and-capsicum-security-audit-funded-by-alpha-omega-project/) URL: [https://freebsdfoundation.org/news-and-events/latest-news/freebsd-foundation-releases-bhyve-and-capsicum-security-audit-funded-by-alpha-omega-project/](https://freebsdfoundation.org/news-and-events/latest-news/freebsd-foundation-releases-bhyve-and-capsicum-security-audit-funded-by-alpha-omega-project/)  
[FreeBSD 安全审计如何改善我们的安全文化](https://fosdem.org/2025/schedule/event/fosdem-2025-6152-how-freebsd-security-audits-have-improved-our-security-culture/) URL: [https://fosdem.org/2025/schedule/event/fosdem-2025-6152-how-freebsd-security-audits-have-improved-our-security-culture/](https://fosdem.org/2025/schedule/event/fosdem-2025-6152-how-freebsd-security-audits-have-improved-our-security-culture/)  
[ORC WG 的主页](https://github.com/orcwg/orcwg) URL: [https://github.com/orcwg/orcwg](https://github.com/orcwg/orcwg)  
[FreeBSD 基金会：联系我们](https://freebsdfoundation.org/about-us/contact-us/) URL: [https://freebsdfoundation.org/about-us/contact-us/](https://freebsdfoundation.org/about-us/contact-us/)  
[开源漏洞架构 (OSV Schema)](https://openssf.org/projects/osv-schema/) URL: [https://openssf.org/projects/osv-schema/](https://openssf.org/projects/osv-schema/)  
[ossf/osv-schema 工具：导入 VuXML 转换工具](https://github.com/ossf/osv-schema/pull/237) URL: [https://github.com/ossf/osv-schema/pull/237](https://github.com/ossf/osv-schema/pull/237)
...
首先，我们继续致力于 bhyve 和 Capsicum 的源代码审计结果，记录并研究如何防止和减轻类似问题再次发生。这包括与 FreeBSD 项目贡献相关的过程，以及与 Alpha-Omega 在即将到来的 2025 年 FOSDEM 大会期间，在 BSD Devroom 举行联合演讲的准备工作。
...
最后，正在调查将 OSV 工具集成到 FreeBSD 生态系统中的可能性。
...
过程审计已完成。该审计由 FreeBSD 基金会工作人员创建，他们进行了一次外联活动，收集有关当前 FreeBSD 开发过程的信息。咨询的团队包括：安全团队、源代码管理团队、集群管理员、发布工程团队。
...
了解更多关于该项目的信息，并查看历史月度更新，访问：[https://github.com/ossf/alpha-omega/tree/main/alpha/engagements/2024/FreeBSD](https://github.com/ossf/alpha-omega/tree/main/alpha/engagements/2024/FreeBSD)。
...
链接：  
[FreeBSD Wiki 上的 Framework 笔记本页面](https://wiki.freebsd.org/Laptops/Framework_Laptop/) URL: [https://wiki.freebsd.org/Laptops/Framework_Laptop/](https://wiki.freebsd.org/Laptops/Framework_Laptop/)  
...
[跟踪票：Framework 笔记本：功能支持、错误和改进](https://bugs.freebsd.org/262152) URL: [https://bugs.freebsd.org/262152](https://bugs.freebsd.org/262152)
...
长期以来，Framework Laptop Inc 在许多方面对 FreeBSD 项目表现出友好态度，包括为基金会提供工程样品以供测试并支持工作。
...
### 受 PkgBase 激励的 pkg 改进

联系方式：Isaac Freund <[ifreund@freebsdfoundation.org](mailto:ifreund@freebsdfoundation.org)>

阻碍 [PkgBase 项目](https://wiki.freebsd.org/PkgBase)进展的一些问题，源于 [pkg(8)](https://man.freebsd.org/cgi/man.cgi?query=pkg&sektion=8&format=html) 的不足之处。我在 pkg 上的主要工作目标是解除 PkgBase 进展的阻碍。然而，即使用户不使用 PkgBase，所有 pkg 的用户也将受益。

pkg 的安装/升级/删除任务调度器已经被[重写](https://github.com/freebsd/pkg/pull/2330)，该重写是为了应对[PR259785](https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=259785)的问题。新的调度器将调度问题建模为有向图，仅在必要时为打破图中的循环而将升级任务拆分为删除/安装两个部分。这种形式化的模型提供了强有力的顺序保证，而旧的调度器未能提供这些，并且避免了不必要的升级任务拆分。它还修复了旧调度器长期存在的错误，旧调度器会中途放弃，导致整个升级失败。新的调度器已包含在 pkg 版本 1.21.99.3 (pkg-devel) 中。
...
当通过 [pkg-create(8)](https://man.freebsd.org/cgi/man.cgi?query=pkg-create&sektion=8&format=html) 创建一个包时，pkg 会扫描包含的文件，并根据找到的可执行文件/共享库生成 shlibs_provided/shlibs_required 列表。在我的更改之前，pkg 会使用主机系统的 elf 提示文件作为 pkg-create 的输入，以便从生成的 shlibs_required 列表中过滤掉由基础系统提供的共享库。一个 ALLOW_BASE_SHLIBS 选项会禁用此过滤，以便构建 PkgBase 包。

在我的更改之后，pkg-create 不再读取主机系统的 elf 提示文件，基础系统的共享库会包含在生成的 shlibs_required 列表中。当 [pkg-install(8)](https://man.freebsd.org/cgi/man.cgi?query=pkg-install&sektion=8&format=html)/[pkg-upgrade(8)](https://man.freebsd.org/cgi/man.cgi?query=pkg-upgrade&sektion=8&format=html)/等调用求解器时，在非 PkgBase 系统上，pkg 会通过扫描 /lib 和 /usr/lib 来生成基础系统提供的共享库列表，并将其作为求解器的输入。在 PkgBase 系统上，PkgBase 包提供所有基础系统的共享库。

这使得选项 ALLOW_BASE_SHLIBS 得以消除。它还改进了 Port 包与 PkgBase 包之间的集成，因为现在跟踪了 Port 包对 PkgBase 包的共享库依赖，而不是忽略这些依赖。最后，这一变化显著简化了 pkg 的代码库并提高了可移植性。此更改已在 [https://github.com/freebsd/pkg/pull/2386](https://github.com/freebsd/pkg/pull/2386) 中实现，但尚未包含在 pkg 发布版本中。
...
链接：
[改善 FreeBSD 安装程序的修复能力](https://wiki.freebsd.org/SummerOfCode2024Projects/ImprovingRepairAbilityOfTheFreeBSDInstaller) URL: [https://wiki.freebsd.org/SummerOfCode2024Projects/ImprovingRepairAbilityOfTheFreeBSDInstaller](https://wiki.freebsd.org/SummerOfCode2024Projects/ImprovingRepairAbilityOfTheFreeBSDInstaller)  
[GSoC 2024 - 改进带修复和升级能力的安装程序 (#1395)](https://github.com/freebsd/freebsd-src/pull/1395) URL: [https://github.com/freebsd/freebsd-src/pull/1395](https://github.com/freebsd/freebsd-src/pull/1395)  
[bsdinstall: 在实时环境中添加 pkg 安装支持 (#1424)](https://github.com/freebsd/freebsd-src/pull/1424) URL: [https://github.com/freebsd/freebsd-src/pull/1424](https://github.com/freebsd/freebsd-src/pull/1424)  
[bsdinstall: 向安装程序菜单添加修复脚本 (#1427)](https://github.com/freebsd/freebsd-src/pull/1427) URL: [https://github.com/freebsd/freebsd-src/pull/1427](https://github.com/freebsd/freebsd-src/pull/1427)  
[笔记本电脑和桌面工作组](https://wiki.freebsd.org/LaptopDesktopWorkingGroup) URL: [https://wiki.freebsd.org/LaptopDesktopWorkingGroup](https://wiki.freebsd.org/LaptopDesktopWorkingGroup)

联系方式：Pierre Pronchery <[pierre@freebsdfoundation.org](mailto:pierre@freebsdfoundation.org)>

作为 2024 年 GSoC 项目的一部分，我有幸指导 Chun Cheng Yeh（化名 "Leaf"）实现了一些额外功能。目标是增加对修复或更新现有 FreeBSD 安装的支持，同时允许在实时环境中安装软件包。这项工作已经整合为三个不同的 pull request，托管在 GitHub 上。尽管某些方面可能仍然需要进一步打磨才能合并，但将安装程序镜像显著扩展为潜在的救命工具已经触手可及。
...
FreeBSD 音频栈是一个并未像其他领域那样吸引大量关注和开发的领域，因为它在很大程度上没有得到维护，尽管其质量较高，但仍有改进空间——从缺乏音频开发框架，到缺失的用户空间工具，以及与内核驱动相关的 bug。这个项目旨在触及所有这些领域，因此，它更像是一个通用的改进项目，而不是一个特定功能的实现。
...
* 更多 bug 修复、优化和一般改进。
* 实现一个通用的 MIDI 层，类似于 pcm/，并改进/现代化 MIDI 代码库。
* 实现一个蓝牙设备管理工具。
* 对 virtual_oss 进行补丁和改进。
* 尝试自动化 [snd_hda(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_hda&sektion=4&format=html) 引脚修补。
* 调查 SOF/DMIC 支持。

您也可以在 [freebsd-multimedia@](https://lists.freebsd.org/subscription/freebsd-multimedia) 跟踪开发进程，我会定期发布报告。
...
未来工作（没有特定的顺序和时间框架）可能包括：

* 对于 [mac_do(4)](https://man.freebsd.org/cgi/man.cgi?query=mac_do&sektion=4&format=html) 组件：

  * 目前，它只能为从 `/usr/bin/mdo` 可执行文件生成的进程授予凭证过渡。调整此路径的可能性可能对自定义轻量级 jail 布局很有意义。拥有多个此类路径的能力是能够将 [mac_do(4)](https://man.freebsd.org/cgi/man.cgi?query=mac_do&sektion=4&format=html) 与其他授予凭证的程序（如 [sudo(1)](https://man.freebsd.org/cgi/man.cgi?query=sudo&sektion=1&format=html) 和 [doas(1)](https://man.freebsd.org/cgi/man.cgi?query=doas&sektion=1&format=html)）一起使用的一个缺失环节。
  * [mac_do(4)](https://man.freebsd.org/cgi/man.cgi?query=mac_do&sektion=4&format=html) 目前只能在通过新 [setcred(2)](https://man.freebsd.org/cgi/man.cgi?query=setcred&sektion=2&format=html) 请求时授予新凭证，因为它需要看到当前凭证和期望的最终凭证以做出决定。然而，每次调用传统和标准的凭证更改函数，如 [setuid(2)](https://man.freebsd.org/cgi/man.cgi?query=setuid&sektion=2&format=html)、[seteuid(2)](https://man.freebsd.org/cgi/man.cgi?query=seteuid&sektion=2&format=html) 等，都可以被视为一次（有限的）完整过渡，[mac_do(4)](https://man.freebsd.org/cgi/man.cgi?query=mac_do&sektion=4&format=html) 可以对此进行决策。此功能可以更精细地控制向 `root` 的过渡，并且结合前一点的功能，允许安装和使用不需要 "setuid" 位的凭证授予程序。然而，要充分发挥这个新版本的 [mac_do(4)](https://man.freebsd.org/cgi/man.cgi?query=mac_do&sektion=4&format=html) 模块的功能，还需要修改这些程序以使用 [setcred(2)](https://man.freebsd.org/cgi/man.cgi?query=setcred&sektion=2&format=html)。
...
[工作分支](https://github.com/obiwac/freebsd-s0ix) URL: [https://github.com/obiwac/freebsd-s0ix](https://github.com/obiwac/freebsd-s0ix)

联系方式：obiwac <[obiwac@freebsd.org](mailto:obiwac@freebsd.org)>

正在将挂起至空闲和对 S0ix 睡眠的支持添加到 FreeBSD 中。

这将使现代 Intel 和 AMD 笔记本电脑（例如 AMD 和较新的 Intel Framework 笔记本电脑）能够进入低功耗状态，从而增加电池寿命，部分笔记本电脑不支持 ACPI S3 睡眠。

Intel 的 Ben Widawsky 从 2018 年开始致力于此项目，但他的工作从未完成，现在已经过时。如今，这项工作已被接手，首要目标是到 1 月底使 Framework 13 AMD Ryzen 7040 系列的挂起/恢复功能正常工作。计划在 FOSDEM 上进行初步结果的演讲。

目前，AMD 上的所有设备电源约束已经可以解析，以使系统进入低功耗状态。

赞助商：FreeBSD Foundation

---

### umb(4) 驱动程序用于 MBIM USB 4G/5G 调制解调器

链接：  
[UMB(4) - OpenBSD 设备驱动手册](https://man.openbsd.org/umb) URL: [https://man.openbsd.org/umb](https://man.openbsd.org/umb)  
[UMB(4) - NetBSD 内核接口手册](https://man.netbsd.org/umb.4) URL: [https://man.netbsd.org/umb.4](https://man.netbsd.org/umb.4)  
[Bug 263783 - USB MBIM：对 LTE/4G USB 调制解调器的支持](https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=263783) URL: [https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=263783](https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=263783)  
[引入 USB umb(4) 网络驱动程序](https://reviews.freebsd.org/D48167) URL: [https://reviews.freebsd.org/D48167](https://reviews.freebsd.org/D48167)

联系方式：Pierre Pronchery <[pierre@freebsdfoundation.org](mailto:pierre@freebsdfoundation.org)>

移动宽带接口模型（MBIM）是一种与网络 USB 设备进行通信的协议，通过移动宽带网络传输数据包。实现此协议将支持一系列 USB 设备，提供连接到移动网络的功能，如 4G、5G 及其后续技术发展。

此协议的第一个实现是在 2016 年为 OpenBSD 完成的，命名为 umb(4)。我本人在 2019 年将其移植到 NetBSD，并且之后被雇佣使其与 OPNSense 兼容，并获准在 2022 年将其作为开源发布。不幸的是，到了这个时候，FreeBSD 中的一些更改实际上使驱动程序无法使用，直到修复才能合并。

在本季度，我成功地提供了一个更新版本并确认其工作正常（感谢 Mike 和 Zhenlei！）。该版本目前正在 Phabricator 中审查，作为 D48167 提交。该提交仍然基于 2020 年的代码，并且落后于 OpenBSD 自那时以来的进展。因此，它目前仅支持 IPv4。然而，我认为保持审查简单，专注于设计决策和集成，然后逐步导入自那时以来 OpenBSD 上游的改进（尤其是 IPv6 支持）是明智的。

在当前形式下，驱动程序已从原本作为 OPNSense 插件的非内核模块，修改为内核模块及其伴随的二进制文件 umbconfig(8)。这个管理二进制文件有效地允许配置 umb(4) 驱动程序，超出 ifconfig(8) 的功能：可以设置 PIN 或 PUK 代码、APN、用户名/密码或漫游参数，并跟踪连接情况（网络提供商、速度等）。

如果您希望亲自体验并获得由该驱动程序支持的硬件，最重要的功能是支持 MBIM 规范。OpenBSD 的手册页提供了应符合标准的设备列表；请注意，有些设备需要预先配置才能有效地暴露 MBIM 接口。确切的程序是供应商特定的，也可能取决于设备的型号和当前配置。您应参阅您设备的文档，了解所需的任何步骤。
...
[驱动概览](https://people.freebsd.org/~bz/wireless/) URL: [https://people.freebsd.org/~bz/wireless/](https://people.freebsd.org/~bz/wireless/)
...
随着多个无线项目的进行，本报告专注于使用大多未修改的宽松许可的 Linux 无线驱动程序在 FreeBSD 上的工作。

以前直接提交到 FreeBSD src.git 的驱动程序已追溯性地导入到供应商分支并合并到主分支。这使得维护和识别本地更改变得更加容易。 [iwlwifi(4)](https://man.freebsd.org/cgi/man.cgi?query=iwlwifi&sektion=4&format=html)、[rtw88(4)](https://man.freebsd.org/cgi/man.cgi?query=rtw88&sektion=4&format=html) 和 [rtw89(4)](https://man.freebsd.org/cgi/man.cgi?query=rtw89&sektion=4&format=html) 驱动程序已更新至与 Linux 6.11 兼容。

[rtw89(4)](https://man.freebsd.org/cgi/man.cgi?query=rtw89&sektion=4&format=html) 驱动程序已经移植并存在于树中一段时间，并已成功连接到构建中。感谢社区的努力，之前阻止其工作的两个 bug 已被解决。

Ports 中的无线固件已更新，并添加了发行版本。发布构建框架已增强，可以将固件包安装到发行介质中。安装程序增加了支持在已安装的系统上运行 [fwget(8)](https://man.freebsd.org/cgi/man.cgi?query=fwget&sektion=8&format=html) 来安装固件。这一系列改进确保了具有外部固件的（无线）驱动程序可以从安装程序直接使用，并立即在已安装的系统上运行，无需替代连接方式。通过此框架，未来可以轻松地为更多驱动程序添加 [iwlwifi(4)](https://man.freebsd.org/cgi/man.cgi?query=iwlwifi&sektion=4&format=html)、[rtw88(4)](https://man.freebsd.org/cgi/man.cgi?query=rtw88&sektion=4&format=html) 和 [rtw89(4)](https://man.freebsd.org/cgi/man.cgi?query=rtw89&sektion=4&format=html) 支持。这些改进首次随 14.2-RELEASE 发布。

在解决了许多必要的请求之后，时间被用于改进 LinuxKPI 框架中的 HT(802.11n) 和 VHT(802.11ac)，以实现驱动程序和 net80211 之间的同步。硬件加密卸载以及 A-MPDU RX/BA 卸载也在年底前得到了处理。这两项改进对于实现 [iwlwifi(4)](https://man.freebsd.org/cgi/man.cgi?query=iwlwifi&sektion=4&format=html) 更高的吞吐量目标至关重要。

一个半年前的 bug 在未被注意到的情况下阻止了 [rtw88(4)](https://man.freebsd.org/cgi/man.cgi?query=rtw88&sektion=4&format=html) 在主分支和 stable/14 中扫描后的数据包发送，现已收到补丁进行修复。
...
在 FreeBSD Foundation 的支持下，本季度我开始着手将 iwx WiFi 驱动从 OpenBSD 移植到 FreeBSD（通过 Haiku）。iwx 驱动支持许多由 iwlwifi 支持的芯片组，但 OpenBSD 的开发者决定为这些设备支持一个新驱动，而不是让原有驱动变得更加复杂。

目前，OpenBSD 上的 iwx 驱动支持以站点模式运行 80211abgn 和 ac，但尚不支持 ax 速率。该项目的目标是从 OpenBSD 导入一个可维护的驱动程序，并逐步增加支持，直到我们在 FreeBSD 中拥有一个原生驱动，支持 80211ac（并可能支持 80211ax）。

目前，驱动程序支持 80211a 和 80211g，并能够充分利用这些标准所提供的速率的实际限制（大约 28Mbit 向下和 25Mbit 向上）。该驱动程序正在积极开发，并进展迅速。

下个季度的计划是添加对高吞吐量速率的支持，实施监控模式，并稳定驱动程序，准备进行公开测试。

一旦驱动程序足够稳定，将在 [freebsd-current](https://lists.freebsd.org/subscription/freebsd-current) 和 [freebsd-wireless](https://lists.freebsd.org/subscription/freebsd-wireless) 邮件列表中发布测试请求。

赞助商：FreeBSD Foundation

---

### Syzkaller 在 FreeBSD 上的改进

链接：  
[google/syzkaller](https://github.com/google/syzkaller) URL: [https://github.com/google/syzkaller](https://github.com/google/syzkaller)

联系方式：Jian-Lin Li <[ljianlin99@gmail.com](mailto:ljianlin99@gmail.com)>  
联系方式：Li-Wen Hsu <[lwhsu@FreeBSD.org](mailto:lwhsu@FreeBSD.org)>

Syzkaller 是一个操作系统内核模糊测试工具，可以查找内核中的漏洞。

本项目旨在改进 Syzkaller 在 FreeBSD 上的支持。基于现有的用于 Linux 的 WiFi 模糊测试工具，我们为 FreeBSD 草拟了一个 WiFi 模糊测试工具。我们计划使用 [wtap(4)](https://man.freebsd.org/cgi/man.cgi?query=wtap&sektion=4&format=html)，一个用于测试的虚拟 WiFi 驱动程序，来支持 WiFi 模糊测试。

一些设计细节包括：

* 为 wtap 引入一个新的 netlink 命令，以实现帧注入，这是 WiFi 模糊测试的关键。
...
链接：  
[Codeberg 上的仓库](https://codeberg.org/Honeyguide/freebsd-pinephonepro) URL: [https://codeberg.org/Honeyguide/freebsd-pinephonepro](https://codeberg.org/Honeyguide/freebsd-pinephonepro)
...
* 还实现了实时时钟的驱动程序，使系统在重启之间能够保持时间。
* 编写了 RK818 电池充电器和电池监控器的驱动程序，使电池能够通过 USB 充电，并通过 sysctl 获取一些电池信息，如电压和充电状态。
* 代码仓库已更新，包含如何编译自定义内核和设备树的脚本和文档，并将其补丁应用到 FreeBSD 15-CURRENT 镜像中，以便在 Pinephone Pro 上启动。

下一步是启用基于 UEFI 的帧缓冲支持，以启用屏幕输出，并启用 USB 即插即用功能，这可能允许插入 USB 键盘和/或以太网。还将考虑移植 WiFi 的 Linux 驱动程序。鼓励任何有兴趣的开发人员与我们联系。欢迎更多反馈和测试人员。

如果您希望参与，请查看 [FreeBSD 论坛上的此帖](https://forums.freebsd.org/threads/porting-freebsd-to-pinephone-pro-help-needed.95948/)。
...
链接：  
[Microsoft Azure 上的 FreeBSD 文章](https://wiki.freebsd.org/MicrosoftAzure) URL: [https://wiki.freebsd.org/MicrosoftAzure](https://wiki.freebsd.org/MicrosoftAzure)  
[Microsoft HyperV 上的 FreeBSD 文章](https://wiki.freebsd.org/HyperV) URL: [https://wiki.freebsd.org/HyperV](https://wiki.freebsd.org/HyperV)
...
来自 Microsoft 的 Souradeep Chakrabarti 添加了一个特性，用于在 Hyper-V 和 Azure 上使用超调用进行 TLB 清除。

Wei Hu 根本原因分析了在最新的 Azure v6 VM SKU 上启动 FreeBSD 时缺少 CDROM 设备的问题。V6 类型仅向来宾操作系统提供 NVMe 磁盘。他还继续修复 FreeBSD MANA NIC 设备的 bug。
...
赞助商：Microsoft（提供 Microsoft 内部人员和其他资源）  
赞助商：The FreeBSD Foundation（提供其他所有资源）
...
在第四季度，我们的主要目标是通过建立一个新的环境来最终完成里程碑 1 中承诺的任务，以展示一个可行的概念验证（POC）站点。然而，同时建立另一个基于 FreeBSD Jail 的部署环境使我们花费了大量时间在网络设计和调优上。幸运的是，我们成功地在本季度末建立了客人虚拟机的外部网络连接。剩下的挑战是使虚拟机能够通过 cloud-init 自动获取 IP 地址。

另外，我们尝试从基于 Linux 的 OpenStack 获取虚拟机的域 XML，以便与用于 bhyve 虚拟机的 XML 进行比较。这些域 XML 由 Libvirt 使用，定义了每个虚拟机的配置和操作参数。比较两者之间的差异将有助于开发“bhyve 串行控制台通过 TCP”的工作。
...
[云原生构建包 (CNBs)](https://buildpacks.io/) 将应用程序源代码转换为容器镜像。这些镜像可以在任何云平台上运行。通过构建包，组织可以将容器构建最佳实践的知识集中在一个专业团队中，而不是让组织内的应用程序开发人员单独维护他们自己的 Dockerfile。
...
在查看这些更改后，我决定首先引入一些通用的清理步骤，以保持 FreeBSD 所需的更改尽可能小。
...
通过这些步骤，现在可以在 FreeBSD 上编译 `lifecycle`。
...
链接：
[EC2 启动性能随时间变化](https://www.daemonology.net/freebsd-ec2-boot-performance/) URL: [https://www.daemonology.net/freebsd-ec2-boot-performance/](https://www.daemonology.net/freebsd-ec2-boot-performance/)

联系方式：Colin Percival <[cperciva@FreeBSD.org](mailto:cperciva@FreeBSD.org)>

FreeBSD 可在 amd64（Intel 和 AMD）和 arm64（Graviton）EC2 实例上运行。

在过去一个季度中，ZFS AMI 的首次启动性能有了显著改善，例如，15.0 "base" AMI 在 amd64 上的启动时间从约 22 秒减少到约 11 秒。启动性能的图表现在会自动生成并发布；典型的启动时间为 "base" 和 "small" AMI 约 9-12 秒，而 "cloud-init" AMI 为 14-18 秒。
...
链接：[FreeBSD 文档项目新贡献者指南](https://docs.freebsd.org/en/books/fdp-primer/) URL: [https://docs.freebsd.org/en/books/fdp-primer/](https://docs.freebsd.org/en/books/fdp-primer/)  
...
doceng@ 团队负责处理与 FreeBSD 文档项目相关的一些元项目问题；有关更多信息，请参阅 [FreeBSD Doceng 团队章程](https://www.freebsd.org/internal/doceng/)。
...
请帮助在您的本地用户组推广此工作；我们始终需要更多的志愿者。

#### DocEng 维护的包

在本季度，doceng@ 维护的以下包进行了更新：
...
在 Bugzilla 中有 1 个分配给 doceng@ 的未解决 PR：
...
链接：  
[项目 Wiki 页面](https://wiki.freebsd.org/portconfig) URL: [https://wiki.freebsd.org/portconfig](https://wiki.freebsd.org/portconfig)

联系方式：FreeBSD 无障碍性邮件列表 <[freebsd-accessibility@FreeBSD.org](mailto:freebsd-accessibility@FreeBSD.org)>  
联系方式：Alfonso Sabato Siciliano <[asiciliano@FreeBSD.org](mailto:asiciliano@FreeBSD.org)>

FreeBSD 提供 Ports ，为用户和管理员提供了一个简单的应用程序安装方式。该集合提供了成千上万的 Port；Port 配置是其核心功能之一。在构建和安装之前，可以配置 Port。命令 "make config" 使用文本用户界面（TUI）以交互方式设置 Port 选项。

最近，低视力用户（主要是白内障患者）要求新增功能，便于轻松改变 TUI 的颜色。已实现多个功能，允许改变颜色，例如：通过设置环境变量将 UI 设置为黑白模式，或者在运行时通过读取配置文件来设置颜色。所有这些功能自版本 0.6.2 起都已在 [portconfig(1)](https://man.freebsd.org/cgi/man.cgi?query=portconfig&sektion=1&format=html) 中描述。
...
### Containers 和 FreeBSD：AppJail、Director、OCI 等
...
[LittleJet on GitHub](https://github.com/DtxdF/LittleJet) URL: [https://github.com/DtxdF/LittleJet](https://github.com/DtxdF/LittleJet)  
[Reproduce on GitHub](https://github.com/DtxdF/reproduce) URL: [https://github.com/DtxdF/reproduce](https://github.com/DtxdF/reproduce)

联系方式：Jesús Daniel Colmenares Oviedo <[DtxdF@disroot.org](mailto:DtxdF@disroot.org)>

AppJail 是一个开源的 BSD-3 许可框架，完全用 POSIX shell 和 C 编写，用于通过 FreeBSD jail 创建隔离、便携且易于部署的环境，且这些环境表现得像一个应用程序。

Director 是一个工具，用于通过简单的 YAML 配置文件在 AppJail 上运行多 jail 环境。Director 文件用于定义构成应用程序的一个或多个 jail 的配置。一旦有了 Director 文件，就可以通过一个命令 `appjail-director up` 来创建并启动应用程序。

LittleJet 是一个开源的、易于使用的编排工具，用于管理、部署、扩展和互联全球各地的 FreeBSD jails。
...
我还在不断添加更多 Makejails，这是一个简单的文本文件，用于自动化部署服务到 jails。如果你想贡献代码，可以访问我在 GitHub 上创建的组织 [The Centralized Repository](https://github.com/AppJail-makejails)。[最近的改进是将 BuildBot 实现为 AppJail 镜像的 CI/CD](https://github.com/AppJail-makejails/#status)，因此对 BuildBot 跟踪的仓库所做的任何更改都会生成新的任务来构建和部署镜像到镜像站点。如果镜像站点不可用， [appjail-reproduce](https://github.com/DtxdF/reproduce) 可以用来利用你自己的资源构建镜像。
...
FreeBSD 的 ports 树已经提供了 CL 支持多年。最初的工作由 Henrik Motakef 于 2003 年贡献，然后由 Jimmy Olgeni 强化和维护。该基础设施使得使用 [ASDF](https://asdf.common-lisp.dev/) 构建和安装 CL 库成为可能，从而可以加载多个 CL 实现的已编译目标代码文件（fasl），而不会发生冲突。
...
Erlang 运行时系统，通常称为 BEAM，提供了一个运行时环境，许多编程语言和应用程序都使用它，这些应用程序可以在 FreeBSD  Ports 中找到。
...
欢迎进行更多的测试和社区贡献；如果您能够帮助测试特定 Port 的更新，请通过邮件列表联系我们。
...
* Java 测试回归工具（jtreg）现已在 FreeBSD 上 [构建并运行](https://github.com/snake66/jtreg/tree/freebsd-port)，并已开始 [将更改上游](https://github.com/openjdk/jtreg/pull/237)。
* OpenJDK 23 可以在 FreeBSD 上构建和运行，且正在开始将其加入 Ports ；这仍然被视为实验性质。[https://reviews.freebsd.org/D48194](https://reviews.freebsd.org/D48194)
* 开始为下一个 OpenJDK 版本（24）进行移植工作。[https://github.com/snake66/jdk/tree/jdk24-freebsd](https://github.com/snake66/jdk/tree/jdk24-freebsd)
...
链接：
[Xfce 4.20 上游发布公告](https://xfce.org/about/news/?post=1734220800) URL: [https://xfce.org/about/news/?post=1734220800](https://xfce.org/about/news/?post=1734220800)  
[在 FreshPorts 上的 Xfce 元 Port ](https://www.freshports.org/x11-wm/xfce4) URL: [https://www.freshports.org/x11-wm/xfce4](https://www.freshports.org/x11-wm/xfce4)
...
链接：
[LXQt 项目](https://lxqt-project.org/) URL: [https://lxqt-project.org/](https://lxqt-project.org/)  
[LXQt 项目 GitHub](https://github.com/lxqt/) URL: [https://github.com/lxqt](https://github.com/lxqt)

联系人：LXQt 团队 <[lxqt@FreeBSD.org](mailto:lxqt@FreeBSD.org)>

LXQt 是一个先进、易于使用且快速的桌面环境，基于 Qt 技术。它为重视简洁性、速度和直观界面的用户量身定制。与大多数桌面环境不同，LXQt 也能在低性能的机器上正常运行。

在本季度，[x11-wm/lxqt](https://cgit.freebsd.org/ports/tree/x11-wm/lxqt/) 元 Port 已更新至 2.1.0。此次更新为 LXQt 桌面增加了初步的 [Wayland 支持](https://github.com/lxqt/lxqt/wiki/ConfigWaylandSettings/)。你可以 [在此阅读一些发布亮点](https://lxqt-project.org/release/2024/11/05/release-lxqt-2-1-0/)。
...
[GCC 11 版本系列](https://gcc.gnu.org/gcc-11/) URL: [https://gcc.gnu.org/gcc-11/](https://gcc.gnu.org/gcc-11/)  
[GCC 12 版本系列](https://gcc.gnu.org/gcc-12/) URL: [https://gcc.gnu.org/gcc-12/](https://gcc.gnu.org/gcc-12/)  
...
如果你维护任何受影响的 Port ，或想帮助准备和测试一些补丁，可以考虑尝试在受影响的 Port 中将 `-fpermissive` 添加到 `CFLAGS` 作为临时解决方案：GCC 14 将一些警告转化为错误，这是导致许多构建失败的原因。`-fpermissive` 标志会将这些错误转换回警告。然而，更好的方法是上游更新其代码，以完全消除这些警告，从而不再需要 `-fpermissive`，可能需要 FreeBSD Ports 维护人员的支持。如果上游不再维护代码，可能是时候弃用该 Port 了。
...
链接：  
[Tor 项目主页](https://www.torproject.org/) URL: [https://www.torproject.org/](https://www.torproject.org/)  
[GitLab 仓库](https://gitlab.torproject.org/tpo/applications/tor-browser) URL: [https://gitlab.torproject.org/tpo/applications/tor-browser](https://gitlab.torproject.org/tpo/applications/tor-browser)

联系人：Martin Filla <[freebsd@sysctl.cz](mailto:freebsd@sysctl.cz)>

自上次报告以来，FreeBSD 上的 Tor Browser 构建和打包工作取得了显著进展。此外，Tor Browser 的版本已更新为 14.0.3，现已可以从 [Tor Browser 下载页面](https://www.torproject.org/download/) 和我们的 [分发目录](https://www.torproject.org/dist/) 下载。

此更新包含了对 Firefox 的重要安全更新，确保用户能够受益于增强的安全性和隐私功能。扩大 FreeBSD 兼容性仍然是优先事项，以为平台提供无缝且原生的隐私解决方案。

新功能：Tor Browser 版本 14.0.3 包含：
...
测试：需要志愿者在 FreeBSD 上测试 Tor Browser 14.0.3 以识别边缘情况。  
...
链接：  
[Greenbone](https://www.greenbone.net/en/) URL: [https://www.greenbone.net/en/](https://www.greenbone.net/en/)  
[Greenbone GitHub](https://github.com/greenbone/) URL: [https://github.com/greenbone/](https://github.com/greenbone/)

联系人：José Alonso Cárdenas Márquez <[acm@FreeBSD.org](mailto:acm@FreeBSD.org)>

Greenbone Community Edition (GVM) 涵盖了 Greenbone Vulnerability Management 软件栈的实际源代码，也被称为 OpenVAS 扫描器，它提供了超过 160,000 个漏洞测试的安全源、一个漏洞管理应用程序等。

在本季度，[security/gvm](https://cgit.freebsd.org/ports/tree/security/gvm/) 元 Port 已更新至 24.1.2。此次更新包括以下内容：
...
可以使用 [AppJail](https://github.com/DtxdF/AppJail)、[makejail](https://github.com/alonsobsd/greenbone-openvas-makejail) 或 [https://github.com/AppJail-makejails/greenbone-openvas](https://github.com/AppJail-makejails/greenbone-openvas) 进行快速的 GVM jail 安装测试。

欢迎任何有兴趣帮助该项目或捐赠 aarch64 设备进行测试的人。
...
Wazuh 解决方案包括一个端点安全代理，部署到被监控的系统，以及一个管理服务器，用于收集和分析代理收集的数据。此外，Wazuh 已完全与 Elastic Stack 或 OpenSearch Stack 集成，提供一个搜索引擎和数据可视化工具，使用户能够浏览其安全警报。
...
### 一个用 Freepascal/Lazarus 编写的 bhyve 管理 GUI
...
Bhyvemgr 是一个在 FreeBSD 上用 Freepascal/Lazarus 编写的 bhyve 管理 GUI。它需要一组主要安装在基础系统上的工具，以及一些从 Ports/包安装的工具。该应用程序旨在帮助桌面用户轻松快捷地在 FreeBSD 主机上设置和运行虚拟机。

在本季度，Bhyvemgr 进行了许多 bug 修复和改进。

添加的部分新功能包括：

* 支持在 CURRENT 上通过软件 (swtpm) 使用受信平台模块 (TPM)
* 支持 Bootvars
* 可修改 BIOS、系统、主板和机箱信息
* 几乎所有桌面环境中支持系统托盘图标（已在 Plasma、Gnome、Xfce、LXQt 和 IceWM 中测试）
...
* 通过 `pkg` 安装，并支持 gtk2、qt5 或 qt6 界面。
...
链接：[项目页面](https://github.com/sobomax/qemu-bsd-user-l4b) URL: [https://github.com/sobomax/qemu-bsd-user-l4b](https://github.com/sobomax/qemu-bsd-user-l4b)  
[工具集](https://github.com/sobomax/qemu_l4b) URL: [https://github.com/sobomax/qemu_l4b](https://github.com/sobomax/qemu_l4b)

`bsd-user-4-linux` 项目将 BSD 用户模式仿真移植到 Linux 上。其主要目标是使未修改的 FreeBSD 二进制文件能够在现代 Linux 系统上运行。此外，该项目旨在提供具有功能性的 FreeBSD 环境和现成的 GitHub Actions 模板的多平台容器镜像。

当前状态：

* 初始移植成功运行 `make -jN buildworld`。
* 大多数命令行工具按预期工作（如 `sh`、`bash`、`find`、`grep`、`git`、`clang` 等）。
* 一个 [GitHub Actions 流水线](https://github.com/sobomax/qemu-bsd-user-l4b/actions) 为以下平台构建 x86_64 仿真镜像：
...
链接：  
[桌面邮件列表](https://lists.freebsd.org/archives/freebsd-desktop/) URL: [https://lists.freebsd.org/archives/freebsd-desktop/](https://lists.freebsd.org/archives/freebsd-desktop/)  
[维基页面](https://wiki.freebsd.org/LaptopDesktopWorkingGroup) URL: [https://wiki.freebsd.org/LaptopDesktopWorkingGroup](https://wiki.freebsd.org/LaptopDesktopWorkingGroup)

联系人：Chris Moerz <[freebsd@ny-central.org](mailto:freebsd@ny-central.org)>

2024年10月，Laptop 和 Desktop 工作组 (LDWG) 正式成立，并亲切地被称为“Ludwig”。这一倡议为社区提供了一个协作平台，旨在促进开发、测试、知识交流和 FreeBSD 在笔记本电脑和台式电脑上的推广。欢迎所有有兴趣的人加入。
...
所有活动都已记录在 [工作组的工作表](https://docs.google.com/spreadsheets/d/15btrze2sZrprSBd3Hb3YG27cZqG0AFjcvLlcTTifpIE/edit?gid=0#gid=0) 中。工作组鼓励任何有兴趣贡献的人添加自己的名字。如果有任何计划中的或正在进行的工作，请将其包括在工作表中。
...
Pot 是一个 jail 管理工具，[还支持通过 Nomad 进行编排](https://www.freebsd.org/news/status/report-2020-01-2020-03/#pot-and-the-nomad-pot-driver)。Potluck 旨在成为 FreeBSD 和 Pot 的 Dockerhub，就像 Dockerhub 对 Linux 和 Docker 的作用一样：一个 Pot 风味和完整容器镜像的仓库，供 Pot 使用，在许多情况下也可以与 Nomad 一起使用。

在本季度，[Pot](https://github.com/bsdpot/pot) 没有发布新版本。该工具已经稳定，且已在生产环境中使用一段时间。
